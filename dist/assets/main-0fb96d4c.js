...
var A = (a, e, t) =>
  e in a
    ? F(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (a[e] = t)
var n = (a, e, t) => (A(a, typeof e != 'symbol' ? e + '' : e, t), t)
;(function () {
...
const B = { HOME: '/' },
  ...
  G = { ...B, ...H }
function $(a) {
  const t = Object.entries(G).find(([i, r]) => r === a)
  return t ? t[0] : void 0
}
const L = {
...
class O {
  ...
  getCalculatorDescription(e) {
    return L[e] ?? 'Description not available.'
  }
}
class V {
  constructor() {
...
const s = {
  ...
  T = {
    inputs: {
      ...
      weeksToWeightGoal: `#${s.weeksToWeightGoal}`,
...
class f {
  constructor(e) {
    n(this, 'form', null)
    n(this, 'resultsTable', null)
    n(this, 'errorMessage', null)
    n(this, 'inputs', new Map())
    n(this, 'selects', new Map())
    n(this, 'getSelectedUnitSystem')
    this.getSelectedUnitSystem = e
  }
  initializeCommonElements() {
    ;(this.form = this.getElement(T.common.form)),
      (this.resultsTable = this.getElement(T.common.resultTable)),
      (this.errorMessage = this.getElement(T.common.errorMessage))
  }
  initializeInputs(e) {
    e.forEach((t) => this.initializedInputField(t))
  }
  initializedInputField(e) {
    const t = this.getElement(T.inputs[e])
    t && this.inputs.set(e, t)
  }
  initializeSelectField(e) {
    const t = this.getElement(T.selects[e])
    t && this.selects.set(e, t)
  }
  bindFormEvents(e) {
    var i
    ;(i = this.form) == null ||
    ...
    const t = this.selects.get('unitSystem')
    t && t.addEventListener('change', () => this.updatePlaceholders())
  }
  bindResetEvent(e) {
    var i
    const t =
      (i = this.form) == null ? void 0 : i.querySelector('button[type="reset"]')
    t == null ||
  ...
  setSelectValue(e, t) {
    const i = this.selects.get(e)
    i && t && (i.value = t)
  }
  setInputValue(e, t) {
    const i = this.inputs.get(e)
    i && t !== void 0 && (i.value = t.toString())
  }
  fillFormData(e) {
    e.unitSystem && this.setSelectValue('unitSystem', e.unitSystem),
      Object.entries(e).forEach(([t, i]) => {
        typeof i == 'number'
          ? this.setInputValue(t, i)
          : typeof i == 'string' &&
            t !== 'unitSystem' &&
            this.setSelectValue(t, i)
      }),
      this.updatePlaceholders()
  }
  clearForm() {
    var e
    ;(e = this.form) == null || e.reset()
  }
  clearResults() {
    if (this.resultsTable) {
      const e = this.resultsTable.rows
  ...
  updatePlaceholders() {
    const e = this.getSelectedUnitSystem()
...
var h = ((a) => ((a.METRIC = 'metric'), (a.IMPERIAL = 'imperial'), a))(h || {})
const _ = `
      <section class="container">
...
class x extends f {
  ...
  updateResults(e) {
    ...
    ;(t[0].cells[1].textContent = e.bmi),
      (t[1].cells[1].textContent = e.category),
      (t[2].cells[1].textContent = e.healthRisk),
      (t[3].cells[1].textContent = e.idealWeight)
  }
}
/**
 * @license
 ...
 */ class D {
  constructor(e, t, i, r, o, l) {
    ;(this.user = e),
      (this.bmiCalculator = t),
      (this.bodycompositionCalculator = i),
      (this.bmrCalculator = r),
      (this.tdeeCalculator = o),
      (this.calorieCalculator = l)
  }
  getBmi() {
  ...
  getBmiType() {
    const e = this.getBmi()
    return this.bmiCalculator.calculateBmiType(e)
  }
  getBmiPrime() {
    const e = this.getBmi()
    return this.bmiCalculator.calculateBmiPrime(e)
  }
  getIdealWeight() {
  ...
  getTdeeHarrisBenedict() {
    const e = this.getBmrHarrisBenedict()
    return this.tdeeCalculator.calculateTdeeHarrisBenedict(this.user, e)
  }
  getTdeeMifflinStJeor() {
    const e = this.getBmrMifflinStJeor()
    return this.tdeeCalculator.calculateTdeeMifflinStJeor(this.user, e)
  }
  getCaloricSurplusOrDeficit() {
    const e = this.getTdeeHarrisBenedict()
    return this.calorieCalculator.calculateCaloricSurplusOrDeficit(this.user, e)
  }
  getEstimatedWeightChangeWeekly() {
    const e = this.getCaloricSurplusOrDeficit()
 ...
 */ var g
;(function (a) {
  ;(a.UnderweightSevereThinness = 'underweight, severe thinness'),
    (a.UnderweightModerateThinness = 'underweight, moderate thinness'),
    (a.UnderweightMildThinness = 'underweight, mild thinness'),
    (a.Normal = 'normal weight'),
    (a.Overweight = 'overweight, pre-obese'),
    (a.ObeseFirstGrade = 'obese, class I'),
    (a.ObeseSecondGrade = 'obese, class II'),
    (a.ObeseThirdGrade = 'obese, class III')
})(g || (g = {}))
const M = [
  { min: 0, max: 15.9, type: g.UnderweightSevereThinness },
  { min: 16, max: 16.9, type: g.UnderweightModerateThinness },
  { min: 17, max: 18.4, type: g.UnderweightMildThinness },
  { min: 18.5, max: 24.9, type: g.Normal },
  { min: 25, max: 29.9, type: g.Overweight },
  { min: 30, max: 34.9, type: g.ObeseFirstGrade },
  { min: 35, max: 39.9, type: g.ObeseSecondGrade },
  { min: 40, max: 100, type: g.ObeseThirdGrade },
]
var E
;(function (a) {
  ;(a.Sedentary = 'sedentary'),
    (a.Lightly = 'lightly'),
    (a.Moderately = 'moderately'),
    (a.Very = 'very'),
 ...
 */ class N {
  calculateBmi(e) {
    this.validateWeightAndHeight(e)
    const t = 2
    return e.weight / Math.pow(e.height, t)
  }
  calculateBmiType(e) {
    this.validateBmi(e)
    const t = this.roundBmi(e)
    return this.findBmiType(t)
  }
  calculateIdealWeight(e) {
    this.validateHeight(e)
    const t = this.getNormalBmiRange(),
      i = this.calculateWeight(t.min, e.height),
      r = this.calculateWeight(t.max, e.height)
    return [i, r]
  }
  calculateBmiPrime(e) {
    return e / 25
  }
  validateWeightAndHeight(e) {
    if (e.weight === void 0 || e.height === void 0)
      throw new Error('Weight and height are required for BMI calculation.')
    if (typeof e.weight != 'number' || typeof e.height != 'number')
  ...
  validateHeight(e) {
    ...
    if (typeof e.height != 'number') throw new Error('Height must be a number.')
    if (e.height <= 0) throw new Error('Height must be a positive number.')
  }
  validateBmi(e) {
    if (e <= 0 || e > 100)
      throw new Error(`BMI out of range. Please check your values. BMI: ${e}`)
  }
  roundBmi(e) {
    return Math.round(e)
  }
  findBmiType(e) {
    for (const t of M) if (e >= t.min && e <= t.max) return t.type
    throw new Error('Bmi Type could not be found')
  }
  getNormalBmiRange() {
    const e = M.find((t) => t.type === g.Normal)
    if (!e) throw new Error('Could not find normal BMI range.')
    return e
  }
  calculateWeight(e, t) {
 ...
 */ class P {
  ...
  calculateWaistToHipRatio(e) {
    return this.validateWaistAndHip(e), e.waist / e.hip
  }
  calculateWaistToHeightRatio(e) {
    this.validateWaistAndHeight(e)
    const t = this.convertHeightToCentimeter(e.height)
    return e.waist / t
  }
  calculateBodyFatPercentage(e) {
    this.validateRequiredMeasurements(e)
    const t = this.convertHeightToCentimeter(e.height)
    return this.calculateBodyFatBasedOnGender(e, t)
  }
  calculateLeanBodyMass(e) {
    this.validateRequiredMeasurements(e)
    const i = this.calculateBodyFatPercentage(e) / this.PERCENTAGE,
      r = this.TOTAL_BODY_COMPOSITION - i
    return e.weight * r
  }
  convertHeightToCentimeter(e) {
    return e * this.CM_PER_METER
  }
  calculateMaleBodyFat(e, t) {
    this.validateWaistAndNeck(e)
    const {
        CONSTANT: i,
        WAIST_NECK_FACTOR: r,
        HEIGHT_FACTOR: o,
      } = this.BODY_FAT_MALE,
      { CONSTANT_FACTOR: l, SUBTRACTION_CONSTANT: u } = this.BODY_FAT,
      y = i - r * Math.log10(e.waist - e.neck) + o * Math.log10(t)
    return l / y - u
  }
  calculateFemaleBodyFat(e, t) {
    this.validateWaistHipAndNeck(e)
    const {
        CONSTANT: i,
        WAIST_HIP_NECK_FACTOR: r,
        HEIGHT_FACTOR: o,
      } = this.BODY_FAT_FEMALE,
      { CONSTANT_FACTOR: l, SUBTRACTION_CONSTANT: u } = this.BODY_FAT,
      y = i - r * Math.log10(e.waist + e.hip - e.neck) + o * Math.log10(t)
    return l / y - u
  }
  validateWaistAndHip(e) {
    if (!e.waist || !e.hip)
      throw new Error(
        'Waist and hip measurements are required for waist to hip calculation.'
      )
  }
  validateWaistAndHeight(e) {
    if (!e.waist || !e.height)
      throw new Error(
        'Waist and height measurements are required for waist to height calculation.'
      )
  }
  validateWaistHipAndNeck(e) {
    if (!e.waist || !e.neck || !e.hip)
      throw new Error(
        'Waist, hip and neck is required to calculate body fat percentage for female'
      )
  }
  validateWaistAndNeck(e) {
    if (!e.waist || !e.neck)
      throw new Error(
        'Waist and neck is required to calculate body fat percentage for male'
      )
  }
  validateRequiredMeasurements(e) {
    if (e.weight === void 0 || e.height === void 0)
      throw new Error(
        'Weight and height are required for body composition calculations.'
      )
  }
  calculateBodyFatBasedOnGender(e, t) {
    if (e.gender === 'male') return this.calculateMaleBodyFat(e, t)
    if (e.gender === 'female') return this.calculateFemaleBodyFat(e, t)
 ...
 */ class U {
  ...
  calculateBmrHarrisBenedict(e) {
    this.validateRequiredFields(e)
    const t = this.convertHeightToCentimeter(e.height)
    return this.calculateBmrBasedOnGender(e, t)
  }
  calculateBmrMifflinStJeor(e) {
    this.validateRequiredFields(e)
    const t = this.convertHeightToCentimeter(e.height),
      i = this.MIFFLIN_ST_JEOR.WEIGHT_FACTOR * e.weight,
      r = this.MIFFLIN_ST_JEOR.HEIGHT_FACTOR * t,
      o = this.MIFFLIN_ST_JEOR.AGE_FACTOR * e.age,
      l =
        e.gender === 'male'
  ...
  calculateBmrBasedOnGender(e, t) {
    if (e.gender === 'male') return this.harrisBenedictMale(e, t)
    if (e.gender === 'female') return this.harrisBenedictFemale(e, t)
    throw new Error("Invalid gender. Gender must be either 'male' or 'female'.")
  }
  validateRequiredFields(e) {
    if (e.weight === void 0 || typeof e.weight != 'number' || e.weight <= 0)
      throw new Error('Valid weight is required for BMR calculation.')
    if (e.height === void 0 || typeof e.height != 'number' || e.height <= 0)
      throw new Error('Valid height is required for BMR calculation.')
    if (e.age === void 0 || typeof e.age != 'number' || e.age <= 0)
      throw new Error('Valid age is required for BMR calculation.')
    if (e.gender === void 0 || (e.gender !== 'male' && e.gender !== 'female'))
      throw new Error(
 ...
 */ class J {
  ...
  calculateTdeeMifflinStJeor(e, t) {
    this.validateAgeAndActivityLevel(e)
    const i = t,
      r = this.getActivityFactor(e.activityLevel)
    return this.calculateTdee(i, r)
  }
  calculateTdeeHarrisBenedict(e, t) {
    this.validateAgeAndActivityLevel(e)
    const i = t,
      r = this.getActivityFactor(e.activityLevel)
    return this.calculateTdee(i, r)
  ...
  validateAgeAndActivityLevel(e) {
    if (!e.age || !e.activityLevel)
...
function K(a) {
  try {
    ...
    const t = `Validation error in user object: ${JSON.stringify(a)} - ${e.message}. Stack trace: ${e.stack}`
    throw new Error(t)
  }
}
function X(a) {
  ;[
    ...
    if (t in a && a[t] !== void 0 && typeof a[t] != 'number')
      throw new TypeError(`${t} must be a number if provided`)
  })
}
function Q(a) {
  if (a.unitSystem === void 0) throw new Error('Unit system is required')
  if (typeof a.unitSystem != 'string')
    throw new TypeError(
      `Unit system must be a string. Check the unitSystem value in ${JSON.stringify(a)}`
    )
  if (a.unitSystem !== 'metric' && a.unitSystem !== 'imperial')
    throw new Error('Unit system must be either "metric" or "imperial"')
}
function W(a, e, t, i, r) {
  if (a < e.min || a > e.max)
    throw new RangeError(
      `${t.charAt(0).toUpperCase() + t.slice(1)} using the ${i} system must be between ${e.min}-${e.max}. Check the ${t.toLowerCase()} value in ${JSON.stringify(r)}`
    )
}
function Z(a) {
  if (typeof a.weight != 'number')
    throw new Error(
      `Weight must be a number if provided. Check the weight value in ${JSON.stringify(a)}`
    )
  const e = a.unitSystem === 'metric' ? Y : q,
    t = a.unitSystem === 'metric' ? 'metric' : 'imperial'
  W(a.weight, e, 'weight', t, a)
}
function ee(a) {
  if (typeof a.height != 'number')
    throw new Error(
      `Height must be a number if provided. Check the height value in ${JSON.stringify(a)}`
    )
  const e = a.unitSystem === 'metric' ? z : j,
    t = a.unitSystem === 'metric' ? 'metric' : 'imperial'
  W(a.height, e, 'height', t, a)
}
function te(a) {
  if (a.gender !== void 0 && a.gender !== 'male' && a.gender !== 'female')
    throw new TypeError(
      `Gender must be male or female. Check the gender value in ${JSON.stringify(a)}`
    )
}
function ie(a) {
  a.age !== void 0 &&
    a.age < 18 &&
    console.warn(
      `Warning: health calculation might not be accurate for individuals under 18 years old. Check the age value in ${JSON.stringify(a)}`
    )
}
function ae(a) {
  const e = ['sedentary', 'lightly', 'moderately', 'very', 'extremely']
  if (a.activityLevel !== void 0 && !e.includes(a.activityLevel))
    throw new TypeError(
      `Activity level must be sedentary, lightly, moderately, very or extremely. Check the activityLevel value in ${JSON.stringify(a)}`
    )
}
function se(a) {
  if (a.dailyCalories !== void 0 && a.dailyCalories < 0)
    throw new Error(
      `Daily calories can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt - ${JSON.stringify(a)}`
    )
}
function re(a) {
  if (a.weightGoal !== void 0 && a.weightGoal < 0)
    throw new Error(
      `The weight goal can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt- ${JSON.stringify(a)}`
    )
}
function oe(a) {
  if (a.weeksToWeightGoal !== void 0 && a.weeksToWeightGoal < 0)
    throw new Error(
      `Weeks to reach weight goal must be equal or greater than 0. User objekt- ${JSON.stringify(a)}`
    )
}
/**
 * @license
 ...
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */ function ne(a) {
  return a.unitSystem === 'metric'
    ? a
    : {
        ...a,
        height: a.height !== void 0 ? he(a.height) : void 0,
        weight: a.weight !== void 0 ? R(a.weight) : void 0,
        waist: a.waist !== void 0 ? I(a.waist) : void 0,
        hip: a.hip !== void 0 ? I(a.hip) : void 0,
        neck: a.neck !== void 0 ? I(a.neck) : void 0,
        weightGoal: a.weightGoal !== void 0 ? R(a.weightGoal) : void 0,
        unitSystem: 'metric',
      }
}
function he(a) {
  return a !== void 0 ? a * 0.3048 : void 0
}
function R(a) {
  return a !== void 0 ? a * 0.453592 : void 0
}
function I(a) {
  return a !== void 0 ? a * 2.54 : void 0
}
/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */ class ce {
  ...
  calculateCaloricSurplusOrDeficit(e, t) {
    return this.validateDailyCalories(e), t - e.dailyCalories
  }
  calculateEstimatedWeightChangeWeekly(e, t) {
    return (
      this.validateWeight(t), this.estimateWeightChange(e, t, this.DAYS_IN_WEEK)
    )
  }
  calculateEstimatedWeightChangeMonthly(e, t) {
    return (
      this.validateWeight(t),
      this.estimateWeightChange(e, t, this.DAYS_IN_MONTH)
    )
  }
  calculateEstimatedWeeksToWeightGoal(e, t) {
    this.validateWeightGoal(t), this.validateWeight(t)
    const i = this.estimateWeightChange(e, t, this.DAYS_IN_WEEK),
      r = t.weightGoal - t.weight,
      l = Math.abs(r) / Math.abs(i)
    return Math.ceil(l)
  }
  calculateCaloriesForWeightGoal(e, t) {
    this.validateWeightGoal(e),
      this.validateWeight(e),
      this.validateWeeksToWeightGoal(e)
    const i = e.weightGoal - e.weight,
      l =
        ((Math.abs(i) / e.weeksToWeightGoal) * this.CALORIES_PER_KILO) /
        this.DAYS_IN_WEEK
    return i > 0 ? Math.round(t + l) : Math.round(t - l)
  }
  validateDailyCalories(e) {
    if (
      e.dailyCalories === void 0 ||
      typeof e.dailyCalories != 'number' ||
      e.dailyCalories < 0
    )
      throw new Error('Valid dailyCalories is required for calorie calculation')
  }
  validateWeightGoal(e) {
    if (
      e.weightGoal === void 0 ||
      typeof e.weightGoal != 'number' ||
      e.weightGoal <= 0
    )
      throw new Error(
  ...
  validateWeeksToWeightGoal(e) {
    if (
      e.weeksToWeightGoal === void 0 ||
      typeof e.weeksToWeightGoal != 'number' ||
      e.weeksToWeightGoal <= 0
    )
      throw new Error(
        'Valid weeksToWeightGoal is required for some calorie calculations'
      )
  }
  estimateWeightChange(e, t, i) {
    const r = this.CALORIES_PER_KILO * (t.weight / this.REFERENCE_WEIGHT)
    return (e * i) / r
  }
}
/**
 ...
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */ class de {
  static createHealthCalculator(e) {
    K(e)
    const t = le(e),
      i = ne(t),
      r = new N(),
      ...
      u = new J(),
      y = new ce()
    return new D(i, r, o, l, u, y)
  }
}
var m = ((a) => (
  (a.UNDERWEIGHT_SEVERE = 'underweight, severe thinness'),
  (a.UNDERWEIGHT_MODERATE = 'underweight, moderate thinness'),
  (a.UNDERWEIGHT_MILD = 'underweight, mild thinness'),
  (a.NORMAL_WEIGHT = 'normal weight'),
  (a.OVERWEIGHT_PRE_OBESE = 'overweight, pre-obese'),
  (a.OBESE_CLASS_I = 'obese, class I'),
  (a.OBESE_CLASS_II = 'obese, class II'),
  (a.OBESE_CLASS_III = 'obese, class III'),
  a
))(m || {})
const ue = {
  [m.UNDERWEIGHT_SEVERE]:
    'High risk of malnutrition, weakened immune system, and more.',
  [m.UNDERWEIGHT_MODERATE]:
    'Risks include nutrient deficiencies and weakened immune response.',
  [m.UNDERWEIGHT_MILD]: 'Moderate risk of malnutrition.',
  [m.NORMAL_WEIGHT]: 'Lowest health risks with a balanced lifestyle.',
  [m.OVERWEIGHT_PRE_OBESE]:
    'Increased risk of cardiovascular diseases and type 2 diabetes.',
  [m.OBESE_CLASS_I]:
    'Significant risk of metabolic syndrome and heart disease.',
  [m.OBESE_CLASS_II]: 'Increased risk for heart disease and stroke.',
  [m.OBESE_CLASS_III]: 'Severe health risks including reduced life expectancy.',
}
function ge(a) {
  return ue[a] || 'Unknown health risk.'
}
class me {
  constructor(e) {
    n(this, 'calculator')
    ;(this.userModel = e), (this.calculator = this.createCalculator())
  }
  createCalculator() {
    const e = this.userModel.getData()
    return de.createHealthCalculator({
      ...
      dailyCalories: e.dailyCalories,
      weightGoal: e.weightGoal,
      weeksToWeightGoal: e.weeksToWeightGoal,
    })
  }
  getBmi() {
  ...
  getBmiType() {
    ...
    const e = this.calculator.getBmiType()
    return this.convertBmiCategoryFromString(e)
  }
  convertBmiCategoryFromString(e) {
    const t = e.toLowerCase().trim()
    for (const [i, r] of Object.entries(m))
      if (r.toLowerCase() === t) return m[i]
    throw new Error(`Invalid BMI category: ${e}`)
  }
  getHealthRisk() {
    return ge(this.getBmiType())
  }
  getBmiPrime() {
    return (
...
class w {
  constructor(e, t, i) {
    n(this, 'user')
    n(this, 'calculator')
    n(this, 'formValidator')
    ;(this.user = e), (this.calculator = t), (this.formValidator = i)
  }
  bindFormEvents(e) {
    this.view.bindFormEvents((t) => {
      e(t)
    }),
  ...
  fillFormData(e) {
    e.unitSystem && this.view.setSelectValue('unitSystem', e.unitSystem),
      Object.entries(e).forEach(([t, i]) => {
        typeof i == 'number'
          ? this.view.setInputValue(t, i)
          : typeof i == 'string' && this.view.setSelectValue(t, i)
      }),
      this.updatePlaceholders()
  }
  updatePlaceholders() {
...
class ye extends w {
  constructor(t, i, r) {
    super(t, i, r)
    n(this, 'view')
    this.view = new x(this.getUnitSystemValue.bind(this))
  }
  init(t) {
    this.view.render(t),
  ...
  getUnitSystemValue() {
    return this.user.getData().unitSystem ?? h.METRIC
  }
  handleCalculate(t) {
    try {
      const i = this.parseFormData(t)
      this.formValidator.validateIBmiFormData(i),
        this.user.setData(i),
        this.updateView(),
        this.view.hideError()
    } catch (i) {
  ...
  parseFormData(t) {
    return {
      unitSystem: t.get('unitSystem'),
      weight: parseFloat(t.get('weight')),
      height: parseFloat(t.get('height')),
    }
  }
  updateView() {
    const t = this.calculator.getBmi(),
      i = this.calculator.getBmiType(),
      r = this.calculator.getHealthRisk(),
      o = this.calculator.getIdealWeight(),
      l = {
        bmi: this.formatValue(t),
        category: i,
        healthRisk: r,
        idealWeight: this.formatIdealWeight(o),
      }
    this.view.updateResults(l)
  }
  formatValue(t) {
    return t.toFixed(1)
  }
  formatIdealWeight([t, i]) {
    return `${this.formatValue(t)} - ${this.formatValue(i)} kg`
  }
}
const ve = `
<section class="container">
...
class fe extends f {
  ...
  updateResults(e) {
    if (!this.resultsTable) return
    const t = this.resultsTable.rows
    t[0].cells[1].textContent = e.waistToHipRatio
  }
}
class we extends w {
  constructor(t, i, r) {
    super(t, i, r)
    n(this, 'view')
    this.view = new fe(this.getUnitSystemValue.bind(this))
  }
  init(t) {
    this.view.render(t),
      this.fillFormData(this.user.getData()),
  ...
  handleCalculate(t) {
    try {
      const i = this.parseFormData(t)
      this.formValidator.validateWaistToHipRatioFormData(i),
        this.user.setData(i),
        this.updateView(),
        this.view.hideError()
    } catch (i) {
  ...
  parseFormData(t) {
    return {
      unitSystem: t.get('unitSystem'),
      waist: parseFloat(t.get('waist')),
      hip: parseFloat(t.get('hip')),
    }
  }
  updateView() {
    const t = this.calculator.getWaistToHipRatio(),
      i = { waistToHipRatio: this.formatValue(t) }
    this.view.updateResults(i)
  }
  formatValue(t) {
    return t.toFixed(2)
  }
...
class Te extends f {
  ...
  updateResults(e) {
    if (!this.resultsTable) return
    const t = this.resultsTable.rows
    t[0].cells[1].textContent = e.waistToHeightRatio
  }
}
class be extends w {
  constructor(t, i, r) {
    super(t, i, r)
    n(this, 'view')
    this.view = new Te(this.getUnitSystemValue.bind(this))
  }
  init(t) {
    this.view.render(t),
      this.fillFormData(this.user.getData()),
  ...
  handleCalculate(t) {
    try {
      const i = this.parseFormData(t)
      this.formValidator.validateIWaistHeightRatioFormData(i),
        this.user.setData(i),
        this.updateView(),
        this.view.hideError()
    } catch (i) {
  ...
  updateView() {
    const t = this.calculator.getWaistToHeightRatio(),
      i = { waistToHeightRatio: this.formatValue(t) }
    this.view.updateResults(i)
  }
  formatValue(t) {
    return t.toFixed(2)
...
class Ie extends f {
  ...
  setGenderSelection(t) {
    const i = document.querySelector(`input[value="${t}"]`)
    i && (i.checked = !0)
  }
  toggleHipInputVisibility(t) {
    this.hipInputGroup &&
      (this.hipInputGroup.style.display = t ? 'block' : 'none')
  }
  clearHipInput() {
    const t = this.inputs.get('hip')
    t && (t.value = '')
  }
  getHipInputGroup() {
    const t = this.inputs.get('hip')
    return (t == null ? void 0 : t.closest('.input-group')) || null
  }
  updateResults(t) {
    if (!this.resultsTable) return
    const i = this.resultsTable.rows
    ;(i[0].cells[1].textContent = t.bodyFatPercentage),
      (i[1].cells[1].textContent = t.leanBodyMass)
  }
}
var p = ((a) => ((a.MALE = 'male'), (a.FEMALE = 'female'), a))(p || {})
class Se extends w {
  constructor(t, i, r) {
    super(t, i, r)
    n(this, 'view')
    this.view = new Ie(this.getUnitSystemValue.bind(this))
  }
  init(t) {
    this.view.render(t),
      this.view.bindGenderChange(this.handleGenderChange.bind(this))
    const i = this.user.getData()
    this.fillFormData(i),
      i.gender
        ? this.handleGenderChange(i.gender)
        : this.view.toggleHipInputVisibility(!1),
      this.bindFormEvents(this.handleCalculate.bind(this))
  }
  handleGenderChange(t) {
    const i = t === p.FEMALE
    this.view.toggleHipInputVisibility(i), i || this.view.clearHipInput()
  }
  getUnitSystemValue() {
    return this.user.getData().unitSystem ?? h.METRIC
  }
  handleCalculate(t) {
    try {
      const i = this.parseFormData(t)
      this.formValidator.validateIBodyFatPercentageFormData(i),
        this.user.setData(i),
        this.updateView(),
        this.view.hideError()
    } catch (i) {
  ...
  parseFormData(t) {
    const i = {
      ...
      weight: parseFloat(t.get('weight')),
      waist: parseFloat(t.get('waist')),
      neck: parseFloat(t.get('neck')),
    }
    if (i.gender === p.FEMALE) {
      const r = t.get('hip')
      if (r) i.hip = parseFloat(r)
  ...
  updateView() {
    const t = this.calculator.getBodyFatPercentage(),
      i = this.calculator.getLeanBodyMass(),
      r = {
        bodyFatPercentage: this.formatBodyFatPercentage(t),
        leanBodyMass: this.formatLeanBodyMass(i),
      }
    this.view.updateResults(r)
  }
  formatBodyFatPercentage(t) {
    return `${t.toFixed(2)} %`
  }
  formatLeanBodyMass(t) {
    return `${t.toFixed(2)} kg`
  }
}
var c = ((a) => (
  (a.SEDENTARY = 'sedentary'),
...
class Re extends f {
  ...
  updateResults(e) {
    if (!this.resultsTable) return
    const t = this.resultsTable.rows
    ;(t[0].cells[1].textContent = e.totalDailyEnergyExpenditureHarris),
      (t[1].cells[1].textContent = e.totalDailyEnergyExpenditureMifflin)
  }
}
class He extends w {
  constructor(t, i, r) {
    super(t, i, r)
    n(this, 'view')
    this.view = new Re(this.getUnitSystemValue.bind(this))
  }
  init(t) {
    this.view.render(t),
      this.fillFormData(this.user.getData()),
  ...
  handleCalculate(t) {
    try {
      const i = this.parseFormData(t)
      this.formValidator.validateITotalDailyEnergyExpenditureFormData(i),
        this.user.setData(i),
        this.updateView(),
        this.view.hideError()
    } catch (i) {
  ...
  parseFormData(t) {
    return {
      ...
      weight: parseFloat(t.get('weight')),
      height: parseFloat(t.get('height')),
      age: parseFloat(t.get('age')),
      activityLevel: t.get('activityLevel'),
    }
  }
  updateView() {
    const t = this.calculator.getTdeeHarrisBenedict(),
      i = this.calculator.getTdeeMifflinStJeor(),
      r = {
        totalDailyEnergyExpenditureHarris: this.formatValue(t),
        totalDailyEnergyExpenditureMifflin: this.formatValue(i),
      }
    this.view.updateResults(r)
  }
  formatValue(t) {
    return `${t.toFixed(0)} kcal/day`
  }
}
const We = `
  <section class="container">
...
class Fe extends f {
  ...
  updateResults(e) {
    if (!this.resultsTable) return
    const t = this.resultsTable.rows
    ;(t[0].cells[1].textContent = e.basalMetabolicRateHarrisBenedict),
      (t[1].cells[1].textContent = e.basalMetabolicRateMifflinStJeor)
  }
  initializeSelectFields(e) {
    e.forEach((t) => this.initializeSelectField(t))
  }
}
class Ae extends w {
  constructor(t, i, r) {
  ...
  handleCalculate(t) {
    try {
      const i = this.parseFormData(t)
      this.formValidator.validateIBasalMetabolicRateFormData(i),
        this.user.setData(i),
        this.updateView(),
        this.view.hideError()
    } catch (i) {
  ...
  parseFormData(t) {
    ...
    if (!Object.values(p).includes(i.gender))
      throw new Error('Invalid gender value')
    return i
  }
  updateView() {
    const t = this.calculator.getBmrHarrisBenedict(),
      i = this.calculator.getBmrMifflinStJeor(),
      r = {
        basalMetabolicRateHarrisBenedict: this.formatValue(t),
        basalMetabolicRateMifflinStJeor: this.formatValue(i),
      }
    this.view.updateResults(r)
  }
  formatValue(t) {
...
class Ge extends f {
  ...
  updateResults(e) {
    if (!this.resultsTable) return
    const t = this.resultsTable.rows
    t[0].cells[1].textContent = e.weeksToWeightGoal
  }
}
class $e extends w {
  constructor(t, i, r) {
    super(t, i, r)
    n(this, 'view')
    this.view = new Ge(this.getUnitSystemValue.bind(this))
  }
  init(t) {
    this.view.render(t),
      this.fillFormData(this.user.getData()),
  ...
  parseFormData(t) {
    return {
      ...
      age: parseFloat(t.get('age')),
      activityLevel: t.get('activityLevel'),
      weightGoal: parseFloat(t.get('weightGoal')),
      dailyCalories: parseFloat(t.get('dailyCalories')),
    }
  }
  updateView() {
    const t = this.calculator.getEstimateTimeToWeightGoal(),
      i = { weeksToWeightGoal: this.formatValue(t) }
    this.view.updateResults(i)
  }
  formatValue(t) {
    return `${t.toFixed(1)} weeks`
  }
}
const Le = `
  <section class="container">
...
class Oe extends f {
  ...
  updateResults(e) {
    if (!this.resultsTable) return
    const t = this.resultsTable.rows
    t[0].cells[1].textContent = e.dailyCalories
  }
}
class Ve extends w {
  constructor(t, i, r) {
    super(t, i, r)
    n(this, 'view')
    this.view = new Oe(this.getUnitSystemValue.bind(this))
  }
  init(t) {
    this.view.render(t),
      this.fillFormData(this.user.getData()),
  ...
  parseFormData(t) {
    return {
      ...
      activityLevel: t.get('activityLevel'),
      weightGoal: parseFloat(t.get('weightGoal')),
      weeksToWeightGoal: parseFloat(t.get('weeksToWeightGoal')),
    }
  }
  updateView() {
    const t = this.calculator.getCaloriesForWeightGoal(),
      i = { dailyCalories: this.formatValue(t) }
    this.view.updateResults(i)
  }
  formatValue(t) {
    return `${t.toFixed(0)} kcal/day`
...
class S {
  validateNumericInput(e, t) {
    if (typeof e != 'number' || isNaN(e) || e <= 0)
      throw new Error(`Invalid ${t} value`)
  }
  getConvertedLimits(e) {
    const { min: t, max: i, shouldConvert: r, conversionFactor: o } = e
    return r
      ? { min: Math.round(t * o), max: Math.round(i * o) }
      : { min: t, max: i }
  }
  validateRange(e) {
    const { value: t, min: i, max: r, name: o, unit: l } = e
    if (t < i || t > r)
      throw new Error(`${o} must be between ${i} and ${r} ${l}`)
  }
}
const ke = 2.54,
  b = { POUNDS: 2.20462, FEET: 3.28084, INCHES: 1 / ke },
  v = {
    METRIC: { WEIGHT: 'kg', HEIGHT: 'm', MEASUREMENT: 'cm' },
    IMPERIAL: { WEIGHT: 'lbs', HEIGHT: 'ft', MEASUREMENT: 'inches' },
  },
  d = {
    ...
    hip: { min: 50, max: 200 },
    neck: { min: 20, max: 80 },
    calories: { min: 500, max: 1e4 },
    weeksToWeightGoal: { min: 1, max: 520 },
  }
class _e extends S {
  validateWeight(e, t) {
    this.validateNumericInput(e, 'Weight')
    const i = t === h.IMPERIAL,
      { min: r, max: o } = this.getConvertedLimits({
        min: d.weight.min,
        max: d.weight.max,
        shouldConvert: i,
        conversionFactor: b.POUNDS,
      })
    this.validateRange({
      value: e,
      min: r,
      max: o,
      name: 'Weight',
      unit: i ? v.IMPERIAL.WEIGHT : v.METRIC.WEIGHT,
    })
  }
  validateHeight(e, t) {
    this.validateNumericInput(e, 'Height')
    const i = t === h.IMPERIAL,
      { min: r, max: o } = this.getConvertedLimits({
        min: d.height.min,
        max: d.height.max,
        shouldConvert: i,
        conversionFactor: b.FEET,
      })
    this.validateRange({
      value: e,
      min: r,
      max: o,
      name: 'Height',
      unit: i ? v.IMPERIAL.HEIGHT : v.METRIC.HEIGHT,
    })
  }
  validateBodyMeasurement(e, t, i) {
    this.validateNumericInput(e, t)
    const r = i === h.IMPERIAL,
      { min: o, max: l } = this.getConvertedLimits({
        min: d[t].min,
        max: d[t].max,
        shouldConvert: r,
        conversionFactor: b.INCHES,
      })
    this.validateRange({
      value: e,
      min: o,
      ...
      unit: r ? v.IMPERIAL.MEASUREMENT : v.METRIC.MEASUREMENT,
    })
  }
}
class xe extends S {
  validateAge(e) {
    this.validateNumericInput(e, 'Age')
    const t = d.age
    if (e < t.min || e > t.max)
      throw new Error(`Age must be between ${t.min} and ${t.max} years`)
  }
  validateGender(e) {
    if (!Object.values(p).includes(e)) throw new Error('Invalid gender value')
  }
  validateActivityLevel(e) {
    if (!Object.values(c).includes(e))
      throw new Error('Invalid activity level value')
  }
  validateUnitSystem(e) {
    if (!Object.values(h).includes(e))
      throw new Error('Invalid unit system value')
  }
}
class De extends S {
  validateWeightGoal(e, t) {
    this.validateNumericInput(e, 'Weight goal')
    const i = t === h.IMPERIAL,
      { min: r, max: o } = this.getConvertedLimits({
        min: d.weight.min,
        max: d.weight.max,
  ...
  validateWeeksToWeightGoal(e) {
    this.validateNumericInput(e, 'Weeks to weight goal'),
      this.validateRange({
        value: e,
        min: d.weeksToWeightGoal.min,
        max: d.weeksToWeightGoal.max,
        name: 'Weeks to goal',
        unit: 'weeks',
      })
  }
  validateDailyCalories(e) {
    this.validateNumericInput(e, 'Daily calories'),
      this.validateRange({
        value: e,
        min: d.calories.min,
        max: d.calories.max,
...
class Ne {
  constructor() {
    n(this, 'measurementValidator')
    n(this, 'personalInfoValidator')
    n(this, 'goalValidator')
    ;(this.measurementValidator = new _e()),
      (this.personalInfoValidator = new xe()),
      (this.goalValidator = new De())
  }
  validateIBmiFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
      this.measurementValidator.validateWeight(e.weight, e.unitSystem),
      this.measurementValidator.validateHeight(e.height, e.unitSystem)
  }
  validateITotalDailyEnergyExpenditureFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
      this.personalInfoValidator.validateGender(e.gender),
      this.measurementValidator.validateWeight(e.weight, e.unitSystem),
      this.measurementValidator.validateHeight(e.height, e.unitSystem),
      this.personalInfoValidator.validateAge(e.age),
      this.personalInfoValidator.validateActivityLevel(e.activityLevel)
  }
  validateWaistToHipRatioFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
  ...
  validateIWaistHeightRatioFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
      this.measurementValidator.validateBodyMeasurement(
        e.waist,
        'waist',
  ...
  validateIBodyFatPercentageFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
      this.personalInfoValidator.validateGender(e.gender),
      this.measurementValidator.validateWeight(e.weight, e.unitSystem),
      this.measurementValidator.validateBodyMeasurement(
  ...
  validateIBasalMetabolicRateFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
      this.personalInfoValidator.validateGender(e.gender),
      this.measurementValidator.validateWeight(e.weight, e.unitSystem),
      this.measurementValidator.validateHeight(e.height, e.unitSystem),
  ...
  validateICaloriesForWeightGoalFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
      this.personalInfoValidator.validateGender(e.gender),
      this.measurementValidator.validateWeight(e.weight, e.unitSystem),
      this.measurementValidator.validateHeight(e.height, e.unitSystem),
      this.personalInfoValidator.validateAge(e.age),
      this.personalInfoValidator.validateActivityLevel(e.activityLevel),
      this.goalValidator.validateWeightGoal(e.weightGoal, e.unitSystem),
      this.goalValidator.validateWeeksToWeightGoal(e.weeksToWeightGoal)
  }
  validateIEstimateTimeToWeightGoalFormData(e) {
    this.personalInfoValidator.validateUnitSystem(e.unitSystem),
      this.personalInfoValidator.validateGender(e.gender),
      this.personalInfoValidator.validateActivityLevel(e.activityLevel),
      this.measurementValidator.validateWeight(e.weight, e.unitSystem),
      this.measurementValidator.validateHeight(e.height, e.unitSystem),
      this.personalInfoValidator.validateAge(e.age),
      this.goalValidator.validateDailyCalories(e.dailyCalories),
      this.goalValidator.validateWeightGoal(e.weightGoal, e.unitSystem)
  }
}
class Pe {
  constructor(e, t) {
    n(this, 'formValidator')
    ;(this.user = e), (this.calculator = t), (this.formValidator = new Ne())
  }
  createController(e) {
    const i = {
    ...
    if (!i) throw new Error(`No controller found for route: ${e}`)
    return i()
  }
  ...
  createBmiController() {
    return new ye(this.user, this.calculator, this.formValidator)
  }
  createWaistToHipController() {
    return new we(this.user, this.calculator, this.formValidator)
  }
  createWaistToHeightController() {
    return new be(this.user, this.calculator, this.formValidator)
  }
  createBodyFatController() {
    return new Se(this.user, this.calculator, this.formValidator)
  }
  createBmrController() {
    return new Ae(this.user, this.calculator, this.formValidator)
  }
  createTdeeController() {
    return new He(this.user, this.calculator, this.formValidator)
  }
  createWeightGoalController() {
    return new $e(this.user, this.calculator, this.formValidator)
  }
  createCalorieGoalController() {
    return new Ve(this.user, this.calculator, this.formValidator)
  }
}
class Ue {
  constructor(e, t) {
    n(this, 'currentController', null)
    n(this, 'controllerFactory')
    this.controllerFactory = new Pe(e, t)
  }
  listen() {
  ...
  navigate(e) {
    ...
    if (i !== void 0)
      try {
        ;(this.currentController = this.controllerFactory.createController(i)),
          this.currentController.init(t)
      } catch {
        t.innerHTML = '<h2>An error occurred</h2>'
      }
    else t.innerHTML = '<h2>404 Not Found</h2>'
  }
}
class Je {
  constructor() {
    n(this, 'data')
    const e = sessionStorage.getItem('userModel')
    this.data = e ? JSON.parse(e) : { unitSystem: 'metric' }
  }
  setData(e) {
    Object.assign(this.data, e), this.saveToSession()
  }
  getData() {
    return {
  ...
  resetData() {
    ;(this.data = { unitSystem: h.METRIC }), this.saveToSession()
  }
  clearSession() {
...
class Ye {
  constructor() {
    n(this, 'dropdownToggles')
    n(this, 'dropdownMenus')
  ...
  toggleDropdown(e) {
    ...
    e.preventDefault(),
      this.dropdownMenus.forEach((o) => {
        var l
        ;(l = o.parentElement) == null || l.classList.remove('show')
      })
    const t = e.currentTarget,
      i = t.nextElementSibling
    i &&
      i.classList.contains('dropdown-menu') &&
      ((r = t.parentElement) == null || r.classList.toggle('show'))
  }
  handleOutsideClick(e) {
    const t = e.target
    this.dropdownToggles.some((r) => r.contains(t)) ||
...
class qe {
  constructor() {
    ...
    n(this, 'calculator')
    ;(this.user = new Je()),
      (this.calculator = new pe(this.user)),
      (this.router = new Ue(this.user, this.calculator)),
      new Ye()
  }
  start() {
    this.router.listen()

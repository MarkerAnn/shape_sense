var $=Object.defineProperty;var G=(a,e,t)=>e in a?$(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var l=(a,e,t)=>(G(a,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();const L={HOME:"/"},A={BMI:"/bmi",BMR:"/bmr",TDEE:"/tdee",WAIST_TO_HIP:"/waist-to-hip",WAIST_TO_HEIGHT:"/waist-to-height",BODY_FAT:"/body-fat-percentage",CALORIE_GOAL:"/calorie-goal",WEIGHT_GOAL:"/weight-goal"},O={...L,...A};function _(a){const t=Object.entries(O).find(([i,r])=>r===a);return t?t[0]:void 0}const V={BMI:"Body Mass Index (BMI) - A measure of body fat based on weight and height.",BMR:"Basal Metabolic Rate (BMR) - The amount of energy your body needs to maintain basic functions while at rest.",TDEE:"Total Daily Energy Expenditure (TDEE) - The number of calories you burn daily.",WAIST_TO_HIP:"Calculate the ratio between your waist and hip circumference.",WAIST_TO_HEIGHT:"Calculate the ratio between your waist circumference and height.",BODY_FAT:"Estimate the percentage of fat in your body based on measurements.",CALORIE_GOAL:"Estimate daily calorie needs to reach your weight goal",WEIGHT_GOAL:"Calculate the time needed to reach your desired weight."};class k{render(e){e.innerHTML=`
        <section class="container">
          <h2>Our Calculators</h2>
          ${this.renderCalculatorItems()}
        </section>
      `}renderCalculatorItems(){return Object.entries(A).map(([e,t])=>`
    ...
    `;class P extends w{constructor(e){super(e)}render(e){e.innerHTML=D,this.initializeCommonElements(),this.initializeInputs(["weight","height"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.bmi,t[1].cells[1].textContent=e.category,t[2].cells[1].textContent=e.healthRisk,t[3].cells[1].textContent=e.idealWeight}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class U{constructor(e,t,i,r,o,n){this.user=e,this.bmiCalculator=t,this.bodycompositionCalculator=i,this.bmrCalculator=r,this.tdeeCalculator=o,this.calorieCalculator=n}getBmi(){return this.bmiCalculator.calculateBmi(this.user)}getBmiType(){const e=this.getBmi();return this.bmiCalculator.calculateBmiType(e)}getBmiPrime(){const e=this.getBmi();return this.bmiCalculator.calculateBmiPrime(e)}getIdealWeight(){return this.bmiCalculator.calculateIdealWeight(this.user)}getWaistToHipRatio(){return this.bodycompositionCalculator.calculateWaistToHipRatio(this.user)}getWaistToHeightRatio(){return this.bodycompositionCalculator.calculateWaistToHeightRatio(this.user)}getBodyFatPercentage(){return this.bodycompositionCalculator.calculateBodyFatPercentage(this.user)}getLeanBodyMass(){return this.bodycompositionCalculator.calculateLeanBodyMass(this.user)}getBmrHarrisBenedict(){return this.bmrCalculator.calculateBmrHarrisBenedict(this.user)}getBmrMifflinStJeor(){return this.bmrCalculator.calculateBmrMifflinStJeor(this.user)}getTdeeHarrisBenedict(){const e=this.getBmrHarrisBenedict();return this.tdeeCalculator.calculateTdeeHarrisBenedict(this.user,e)}getTdeeMifflinStJeor(){const e=this.getBmrMifflinStJeor();return this.tdeeCalculator.calculateTdeeMifflinStJeor(this.user,e)}getCaloricSurplusOrDeficit(){const e=this.getTdeeHarrisBenedict();return this.calorieCalculator.calculateCaloricSurplusOrDeficit(this.user,e)}getEstimatedWeightChangeWeekly(){const e=this.getCaloricSurplusOrDeficit();return this.calorieCalculator.calculateEstimatedWeightChangeWeekly(e,this.user)}getEstimatedWeightChangeMonthly(){const e=this.getCaloricSurplusOrDeficit();return this.calorieCalculator.calculateEstimatedWeightChangeMonthly(e,this.user)}getEstimateTimeToWeightGoal(){const e=this.getCaloricSurplusOrDeficit();return this.calorieCalculator.calculateEstimatedWeeksToWeightGoal(e,this.user)}getCaloriesForWeightGoal(){const e=this.getTdeeHarrisBenedict();return this.calorieCalculator.calculateCaloriesForWeightGoal(this.user,e)}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */var m;(function(a){a.UnderweightSevereThinness="underweight, severe thinness",a.UnderweightModerateThinness="underweight, moderate thinness",a.UnderweightMildThinness="underweight, mild thinness",a.Normal="normal weight",a.Overweight="overweight, pre-obese",a.ObeseFirstGrade="obese, class I",a.ObeseSecondGrade="obese, class II",a.ObeseThirdGrade="obese, class III"})(m||(m={}));const H=[{min:0,max:15.9,type:m.UnderweightSevereThinness},{min:16,max:16.9,type:m.UnderweightModerateThinness},{min:17,max:18.4,type:m.UnderweightMildThinness},{min:18.5,max:24.9,type:m.Normal},{min:25,max:29.9,type:m.Overweight},{min:30,max:34.9,type:m.ObeseFirstGrade},{min:35,max:39.9,type:m.ObeseSecondGrade},{min:40,max:100,type:m.ObeseThirdGrade}];var T;(function(a){a.Sedentary="sedentary",a.Lightly="lightly",a.Moderately="moderately",a.Very="very",a.Extremely="extremely"})(T||(T={}));/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class J{calculateBmi(e){this.validateWeightAndHeight(e);const t=2;return e.weight/Math.pow(e.height,t)}calculateBmiType(e){this.validateBmi(e);const t=this.roundBmi(e);return this.findBmiType(t)}calculateIdealWeight(e){this.validateHeight(e);const t=this.getNormalBmiRange(),i=this.calculateWeight(t.min,e.height),r=this.calculateWeight(t.max,e.height);return[i,r]}calculateBmiPrime(e){return e/25}validateWeightAndHeight(e){if(e.weight===void 0||e.height===void 0)throw new Error("Weight and height are required for BMI calculation.");if(typeof e.weight!="number"||typeof e.height!="number")throw new Error("Weight and height must be numbers.");if(e.weight<=0||e.height<=0)throw new Error("Weight and height must be positive numbers.")}validateHeight(e){if(e.height===void 0)throw new Error("Height is required for ideal weight calculation.");if(typeof e.height!="number")throw new Error("Height must be a number.");if(e.height<=0)throw new Error("Height must be a positive number.")}validateBmi(e){if(e<=0||e>100)throw new Error(`BMI out of range. Please check your values. BMI: ${e}`)}roundBmi(e){return Math.round(e)}findBmiType(e){for(const t of H)if(e>=t.min&&e<=t.max)return t.type;throw new Error("Bmi Type could not be found")}getNormalBmiRange(){const e=H.find(t=>t.type===m.Normal);if(!e)throw new Error("Could not find normal BMI range.");return e}calculateWeight(e,t){return e*Math.pow(t,2)}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class Y{constructor(){this.CM_PER_METER=100,this.PERCENTAGE=100,this.TOTAL_BODY_COMPOSITION=1,this.BODY_FAT={CONSTANT_FACTOR:495,SUBTRACTION_CONSTANT:450},this.BODY_FAT_MALE={CONSTANT:1.0324,WAIST_NECK_FACTOR:.19077,HEIGHT_FACTOR:.15456},this.BODY_FAT_FEMALE={CONSTANT:1.29579,WAIST_HIP_NECK_FACTOR:.35004,HEIGHT_FACTOR:.221}}calculateWaistToHipRatio(e){return this.validateWaistAndHip(e),e.waist/e.hip}calculateWaistToHeightRatio(e){this.validateWaistAndHeight(e);const t=this.convertHeightToCentimeter(e.height);return e.waist/t}calculateBodyFatPercentage(e){this.validateRequiredMeasurements(e);const t=this.convertHeightToCentimeter(e.height);return this.calculateBodyFatBasedOnGender(e,t)}calculateLeanBodyMass(e){this.validateRequiredMeasurements(e);const i=this.calculateBodyFatPercentage(e)/this.PERCENTAGE,r=this.TOTAL_BODY_COMPOSITION-i;return e.weight*r}convertHeightToCentimeter(e){return e*this.CM_PER_METER}calculateMaleBodyFat(e,t){this.validateWaistAndNeck(e);const{CONSTANT:i,WAIST_NECK_FACTOR:r,HEIGHT_FACTOR:o}=this.BODY_FAT_MALE,{CONSTANT_FACTOR:n,SUBTRACTION_CONSTANT:d}=this.BODY_FAT,v=i-r*Math.log10(e.waist-e.neck)+o*Math.log10(t);return n/v-d}calculateFemaleBodyFat(e,t){this.validateWaistHipAndNeck(e);const{CONSTANT:i,WAIST_HIP_NECK_FACTOR:r,HEIGHT_FACTOR:o}=this.BODY_FAT_FEMALE,{CONSTANT_FACTOR:n,SUBTRACTION_CONSTANT:d}=this.BODY_FAT,v=i-r*Math.log10(e.waist+e.hip-e.neck)+o*Math.log10(t);return n/v-d}validateWaistAndHip(e){if(!e.waist||!e.hip)throw new Error("Waist and hip measurements are required for waist to hip calculation.")}validateWaistAndHeight(e){if(!e.waist||!e.height)throw new Error("Waist and height measurements are required for waist to height calculation.")}validateWaistHipAndNeck(e){if(!e.waist||!e.neck||!e.hip)throw new Error("Waist, hip and neck is required to calculate body fat percentage for female")}validateWaistAndNeck(e){if(!e.waist||!e.neck)throw new Error("Waist and neck is required to calculate body fat percentage for male")}validateRequiredMeasurements(e){if(e.weight===void 0||e.height===void 0)throw new Error("Weight and height are required for body composition calculations.")}calculateBodyFatBasedOnGender(e,t){if(e.gender==="male")return this.calculateMaleBodyFat(e,t);if(e.gender==="female")return this.calculateFemaleBodyFat(e,t);throw new Error('Invalid gender. Gender must be either "male" or "female".')}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class q{constructor(){this.CM_PER_METER=100,this.MIFFLIN_ST_JEOR={WEIGHT_FACTOR:10,HEIGHT_FACTOR:6.25,AGE_FACTOR:5,MALE_ADJUSTMENT:5,FEMALE_ADJUSTMENT:-161},this.HARRIS_BENEDICT={FEMALE:{BASE:447.593,WEIGHT_FACTOR:9.247,HEIGHT_FACTOR:3.098,AGE_FACTOR:4.33},MALE:{BASE:88.362,WEIGHT_FACTOR:13.397,HEIGHT_FACTOR:4.799,AGE_FACTOR:5.677}}}calculateBmrHarrisBenedict(e){this.validateRequiredFields(e);const t=this.convertHeightToCentimeter(e.height);return this.calculateBmrBasedOnGender(e,t)}calculateBmrMifflinStJeor(e){this.validateRequiredFields(e);const t=this.convertHeightToCentimeter(e.height),i=this.MIFFLIN_ST_JEOR.WEIGHT_FACTOR*e.weight,r=this.MIFFLIN_ST_JEOR.HEIGHT_FACTOR*t,o=this.MIFFLIN_ST_JEOR.AGE_FACTOR*e.age,n=e.gender==="male"?this.MIFFLIN_ST_JEOR.MALE_ADJUSTMENT:this.MIFFLIN_ST_JEOR.FEMALE_ADJUSTMENT;return i+r-o+n}convertHeightToCentimeter(e){return e*this.CM_PER_METER}harrisBenedictFemale(e,t){const{BASE:i,WEIGHT_FACTOR:r,HEIGHT_FACTOR:o,AGE_FACTOR:n}=this.HARRIS_BENEDICT.FEMALE,d=r*e.weight,v=o*t,S=n*e.age;return i+d+v-S}harrisBenedictMale(e,t){const{BASE:i,WEIGHT_FACTOR:r,HEIGHT_FACTOR:o,AGE_FACTOR:n}=this.HARRIS_BENEDICT.MALE,d=r*e.weight,v=o*t,S=n*e.age;return i+d+v-S}calculateBmrBasedOnGender(e,t){if(e.gender==="male")return this.harrisBenedictMale(e,t);if(e.gender==="female")return this.harrisBenedictFemale(e,t);throw new Error("Invalid gender. Gender must be either 'male' or 'female'.")}validateRequiredFields(e){if(e.weight===void 0||typeof e.weight!="number"||e.weight<=0)throw new Error("Valid weight is required for BMR calculation.");if(e.height===void 0||typeof e.height!="number"||e.height<=0)throw new Error("Valid height is required for BMR calculation.");if(e.age===void 0||typeof e.age!="number"||e.age<=0)throw new Error("Valid age is required for BMR calculation.");if(e.gender===void 0||e.gender!=="male"&&e.gender!=="female")throw new Error("Valid gender is required for BMR calculation. Gender must be either 'male' or 'female'.")}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class z{constructor(){this.ACTIVITY_FACTORS={SEDENTARY:1.2,LIGHTLY:1.375,MODERATELY:1.55,VERY:1.725,EXTREMELY:1.9}}calculateTdeeMifflinStJeor(e,t){this.validateAgeAndActivityLevel(e);const i=t,r=this.getActivityFactor(e.activityLevel);return this.calculateTdee(i,r)}calculateTdeeHarrisBenedict(e,t){this.validateAgeAndActivityLevel(e);const i=t,r=this.getActivityFactor(e.activityLevel);return this.calculateTdee(i,r)}getActivityFactor(e){switch(e){case T.Sedentary:return this.ACTIVITY_FACTORS.SEDENTARY;case T.Lightly:return this.ACTIVITY_FACTORS.LIGHTLY;case T.Moderately:return this.ACTIVITY_FACTORS.MODERATELY;case T.Very:return this.ACTIVITY_FACTORS.VERY;case T.Extremely:return this.ACTIVITY_FACTORS.EXTREMELY;default:throw new Error("Activity level must be sedentary, lightly, moderately, very, or extremely")}}validateAgeAndActivityLevel(e){if(!e.age||!e.activityLevel)throw new Error("Age and activity level is required")}calculateTdee(e,t){return e*t}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */const K={min:0,max:700},j={min:0,max:1543},X={min:0,max:2.5},Q={min:0,max:8.2};function Z(a){try{ee(a),a.weight!==void 0&&ie(a),a.height!==void 0&&ae(a),se(a),re(a),oe(a),te(a),le(a),ne(a),ce(a)}catch(e){const t=`Validation error in user object: ${JSON.stringify(a)} - ${e.message}. Stack trace: ${e.stack}`;throw new Error(t)}}function ee(a){["age","waist","hip","neck","dailyCalories","weightGoal","weeksToWeightGoal"].forEach(t=>{if(t in a&&a[t]!==void 0&&typeof a[t]!="number")throw new TypeError(`${t} must be a number if provided`)})}function te(a){if(a.unitSystem===void 0)throw new Error("Unit system is required");if(typeof a.unitSystem!="string")throw new TypeError(`Unit system must be a string. Check the unitSystem value in ${JSON.stringify(a)}`);if(a.unitSystem!=="metric"&&a.unitSystem!=="imperial")throw new Error('Unit system must be either "metric" or "imperial"')}function B(a,e,t,i,r){if(a<e.min||a>e.max)throw new RangeError(`${t.charAt(0).toUpperCase()+t.slice(1)} using the ${i} system must be between ${e.min}-${e.max}. Check the ${t.toLowerCase()} value in ${JSON.stringify(r)}`)}function ie(a){if(typeof a.weight!="number")throw new Error(`Weight must be a number if provided. Check the weight value in ${JSON.stringify(a)}`);const e=a.unitSystem==="metric"?K:j,t=a.unitSystem==="metric"?"metric":"imperial";B(a.weight,e,"weight",t,a)}function ae(a){if(typeof a.height!="number")throw new Error(`Height must be a number if provided. Check the height value in ${JSON.stringify(a)}`);const e=a.unitSystem==="metric"?X:Q,t=a.unitSystem==="metric"?"metric":"imperial";B(a.height,e,"height",t,a)}function se(a){if(a.gender!==void 0&&a.gender!=="male"&&a.gender!=="female")throw new TypeError(`Gender must be male or female. Check the gender value in ${JSON.stringify(a)}`)}function re(a){a.age!==void 0&&a.age<18&&console.warn(`Warning: health calculation might not be accurate for individuals under 18 years old. Check the age value in ${JSON.stringify(a)}`)}function oe(a){const e=["sedentary","lightly","moderately","very","extremely"];if(a.activityLevel!==void 0&&!e.includes(a.activityLevel))throw new TypeError(`Activity level must be sedentary, lightly, moderately, very or extremely. Check the activityLevel value in ${JSON.stringify(a)}`)}function le(a){if(a.dailyCalories!==void 0&&a.dailyCalories<0)throw new Error(`Daily calories can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt - ${JSON.stringify(a)}`)}function ne(a){if(a.weightGoal!==void 0&&a.weightGoal<0)throw new Error(`The weight goal can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt- ${JSON.stringify(a)}`)}function ce(a){if(a.weeksToWeightGoal!==void 0&&a.weeksToWeightGoal<0)throw new Error(`Weeks to reach weight goal must be equal or greater than 0. User objekt- ${JSON.stringify(a)}`)}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */function he(a){return{...a}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */function de(a){return a.unitSystem==="metric"?a:{...a,height:a.height!==void 0?ue(a.height):void 0,weight:a.weight!==void 0?W(a.weight):void 0,waist:a.waist!==void 0?R(a.waist):void 0,hip:a.hip!==void 0?R(a.hip):void 0,neck:a.neck!==void 0?R(a.neck):void 0,weightGoal:a.weightGoal!==void 0?W(a.weightGoal):void 0,unitSystem:"metric"}}function ue(a){return a!==void 0?a*.3048:void 0}function W(a){return a!==void 0?a*.453592:void 0}function R(a){return a!==void 0?a*2.54:void 0}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class ge{constructor(){this.DAYS_IN_WEEK=7,this.DAYS_IN_MONTH=30,this.CALORIES_PER_KILO=7700,this.REFERENCE_WEIGHT=70}calculateCaloricSurplusOrDeficit(e,t){return this.validateDailyCalories(e),t-e.dailyCalories}calculateEstimatedWeightChangeWeekly(e,t){return this.validateWeight(t),this.estimateWeightChange(e,t,this.DAYS_IN_WEEK)}calculateEstimatedWeightChangeMonthly(e,t){return this.validateWeight(t),this.estimateWeightChange(e,t,this.DAYS_IN_MONTH)}calculateEstimatedWeeksToWeightGoal(e,t){this.validateWeightGoal(t),this.validateWeight(t);const i=this.estimateWeightChange(e,t,this.DAYS_IN_WEEK),r=t.weightGoal-t.weight,n=Math.abs(r)/Math.abs(i);return Math.ceil(n)}calculateCaloriesForWeightGoal(e,t){this.validateWeightGoal(e),this.validateWeight(e),this.validateWeeksToWeightGoal(e);const i=e.weightGoal-e.weight,n=Math.abs(i)/e.weeksToWeightGoal*this.CALORIES_PER_KILO/this.DAYS_IN_WEEK;return i>0?Math.round(t+n):Math.round(t-n)}validateDailyCalories(e){if(e.dailyCalories===void 0||typeof e.dailyCalories!="number"||e.dailyCalories<0)throw new Error("Valid dailyCalories is required for calorie calculation")}validateWeightGoal(e){if(e.weightGoal===void 0||typeof e.weightGoal!="number"||e.weightGoal<=0)throw new Error("Valid weightGoal is required for some calorie calculations")}validateWeight(e){if(e.weight===void 0||typeof e.weight!="number"||e.weight<=0)throw new Error("Valid weight is required for some calorie calculations")}validateWeeksToWeightGoal(e){if(e.weeksToWeightGoal===void 0||typeof e.weeksToWeightGoal!="number"||e.weeksToWeightGoal<=0)throw new Error("Valid weeksToWeightGoal is required for some calorie calculations")}estimateWeightChange(e,t,i){const r=this.CALORIES_PER_KILO*(t.weight/this.REFERENCE_WEIGHT);return e*i/r}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class me{static createHealthCalculator(e){Z(e);const t=he(e),i=de(t),r=new J,o=new Y,n=new q,d=new z,v=new ge;return new U(i,r,o,n,d,v)}}var p=(a=>(a.UNDERWEIGHT_SEVERE="underweight, severe thinness",a.UNDERWEIGHT_MODERATE="underweight, moderate thinness",a.UNDERWEIGHT_MILD="underweight, mild thinness",a.NORMAL_WEIGHT="normal weight",a.OVERWEIGHT_PRE_OBESE="overweight, pre-obese",a.OBESE_CLASS_I="obese, class I",a.OBESE_CLASS_II="obese, class II",a.OBESE_CLASS_III="obese, class III",a))(p||{});const pe={[p.UNDERWEIGHT_SEVERE]:"High risk of malnutrition, weakened immune system, and more.",[p.UNDERWEIGHT_MODERATE]:"Risks include nutrient deficiencies and weakened immune response.",[p.UNDERWEIGHT_MILD]:"Moderate risk of malnutrition.",[p.NORMAL_WEIGHT]:"Lowest health risks with a balanced lifestyle.",[p.OVERWEIGHT_PRE_OBESE]:"Increased risk of cardiovascular diseases and type 2 diabetes.",[p.OBESE_CLASS_I]:"Significant risk of metabolic syndrome and heart disease.",[p.OBESE_CLASS_II]:"Increased risk for heart disease and stroke.",[p.OBESE_CLASS_III]:"Severe health risks including reduced life expectancy."};function ye(a){return pe[a]||"Unknown health risk."}class ve{constructor(e){l(this,"calculator");this.userModel=e,this.calculator=this.createCalculator()}createCalculator(){const e=this.userModel.getData();return me.createHealthCalculator({unitSystem:e.unitSystem,weight:e.weight,height:e.height,age:e.age,gender:e.gender,waist:e.waist,hip:e.hip,neck:e.neck,activityLevel:e.activityLevel,dailyCalories:e.dailyCalories,weightGoal:e.weightGoal,weeksToWeightGoal:e.weeksToWeightGoal})}getBmi(){return this.calculator=this.createCalculator(),this.calculator.getBmi()}getBmiType(){this.calculator=this.createCalculator();const e=this.calculator.getBmiType();return this.convertBmiCategoryFromString(e)}convertBmiCategoryFromString(e){const t=e.toLowerCase().trim();for(const[i,r]of Object.entries(p))if(r.toLowerCase()===t)return p[i];throw new Error(`Invalid BMI category: ${e}`)}getHealthRisk(){return ye(this.getBmiType())}getBmiPrime(){return this.calculator=this.createCalculator(),this.calculator.getBmiPrime()}getIdealWeight(){return this.calculator=this.createCalculator(),this.calculator.getIdealWeight()}getBodyFatPercentage(){return this.calculator=this.createCalculator(),this.calculator.getBodyFatPercentage()}getWaistToHipRatio(){return this.calculator=this.createCalculator(),this.calculator.getWaistToHipRatio()}getWaistToHeightRatio(){return this.calculator=this.createCalculator(),this.calculator.getWaistToHeightRatio()}getLeanBodyMass(){return this.calculator=this.createCalculator(),this.calculator.getLeanBodyMass()}getBmrMifflinStJeor(){return this.calculator=this.createCalculator(),this.calculator.getBmrMifflinStJeor()}getBmrHarrisBenedict(){return this.calculator=this.createCalculator(),this.calculator.getBmrHarrisBenedict()}getTdeeMifflinStJeor(){return this.calculator=this.createCalculator(),this.calculator.getTdeeMifflinStJeor()}getTdeeHarrisBenedict(){return this.calculator=this.createCalculator(),this.calculator.getTdeeHarrisBenedict()}getCaloricSurplusOrDeficit(){return this.calculator=this.createCalculator(),this.calculator.getCaloricSurplusOrDeficit()}getEstimatedWeightChangeWeekly(){return this.calculator=this.createCalculator(),this.calculator.getEstimatedWeightChangeWeekly()}getEstimatedWeightChangeMonthly(){return this.calculator=this.createCalculator(),this.calculator.getEstimatedWeightChangeMonthly()}getEstimateTimeToWeightGoal(){return this.calculator=this.createCalculator(),this.calculator.getEstimateTimeToWeightGoal()}getCaloriesForWeightGoal(){return this.calculator=this.createCalculator(),this.calculator.getCaloriesForWeightGoal()}}class fe{constructor(e){l(this,"calculator");this.calculator=new ve(e)}getBmi(){return this.calculator.getBmi()}getBmiType(){return this.calculator.getBmiType()}getHealthRisk(){return this.calculator.getHealthRisk()}getBmiPrime(){return this.calculator.getBmiPrime()}getIdealWeight(){return this.calculator.getIdealWeight()}getBodyFatPercentage(){return this.calculator.getBodyFatPercentage()}getWaistToHipRatio(){return this.calculator.getWaistToHipRatio()}getWaistToHeightRatio(){return this.calculator.getWaistToHeightRatio()}getLeanBodyMass(){return this.calculator.getLeanBodyMass()}getBmrMifflinStJeor(){return this.calculator.getBmrMifflinStJeor()}getBmrHarrisBenedict(){return this.calculator.getBmrHarrisBenedict()}getTdeeMifflinStJeor(){return this.calculator.getTdeeMifflinStJeor()}getTdeeHarrisBenedict(){return this.calculator.getTdeeHarrisBenedict()}getCaloricSurplusOrDeficit(){return this.calculator.getCaloricSurplusOrDeficit()}getEstimatedWeightChangeWeekly(){return this.calculator.getEstimatedWeightChangeWeekly()}getEstimatedWeightChangeMonthly(){return this.calculator.getEstimatedWeightChangeMonthly()}getCaloriesForWeightGoal(){return this.calculator.getCaloriesForWeightGoal()}getEstimateTimeToWeightGoal(){return this.calculator.getEstimateTimeToWeightGoal()}}class E{constructor(e,t,i){l(this,"user");l(this,"calculator");l(this,"formValidator");this.user=e,this.calculator=t,this.formValidator=i}bindFormEvents(e){this.view.bindFormEvents(t=>{e(t)}),this.view.bindResetEvent(()=>{this.handleReset()})}handleErrors(e){this.view.showError(e.message)}resetForm(){this.user.resetData(),this.view.clearForm(),this.view.clearResults(),this.view.hideError(),this.view.updatePlaceholders()}fillFormData(e){e.unitSystem&&this.view.setSelectValue("unitSystem",e.unitSystem),Object.entries(e).forEach(([t,i])=>{typeof i=="number"?this.view.setInputValue(t,i):typeof i=="string"&&this.view.setSelectValue(t,i)}),this.updatePlaceholders()}updatePlaceholders(){this.view.updatePlaceholders()}handleFormSubmit(e){e.preventDefault();const t=new FormData(e.target);this.handleCalculate(t)}handleReset(){this.resetForm()}}class b{static kgToLbs(e){return e*this.KG_TO_LBS}static cmToIn(e){return e*this.CM_TO_IN}static formatWeight(e,t){return t?`${(e*this.KG_TO_LBS).toFixed(1)} lbs`:`${e.toFixed(1)} kg`}static formatWeightRange([e,t],i){return i?`${(e*this.KG_TO_LBS).toFixed(1)} - ${(t*this.KG_TO_LBS).toFixed(1)} lbs`:`${e.toFixed(1)} - ${t.toFixed(1)} kg`}static formatBodyFat(e){return`${e.toFixed(2)}%`}static formatLeanMass(e,t){return t?`${(e*this.KG_TO_LBS).toFixed(1)} lbs`:`${e.toFixed(1)} kg`}static isImperial(e){return e.toLowerCase()==="imperial"}}l(b,"KG_TO_LBS",2.20462),l(b,"CM_TO_IN",.393701);class we extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new P(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateIBmiFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height"))}}updateView(){const t=this.calculator.getBmi(),i=this.calculator.getBmiType(),r=this.calculator.getHealthRisk(),o=this.calculator.getIdealWeight(),n=b.isImperial(this.getUnitSystemValue()),d={bmi:this.formatValue(t),category:i,healthRisk:r,idealWeight:b.formatWeightRange(o,n)};this.view.updateResults(d)}formatValue(t){return t.toFixed(1)}}const Ee=`
<section class="container">
...
`;class Te extends w{constructor(e){super(e)}render(e){e.innerHTML=Ee,this.initializeCommonElements(),this.initializeInputs(["hip","waist"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.waistToHipRatio}}class be extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new Te(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateWaistToHipRatioFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),hip:parseFloat(t.get("hip"))}}updateView(){const t=this.calculator.getWaistToHipRatio(),i={waistToHipRatio:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return t.toFixed(2)}}const Ce=`
<section class="container">
...
`;class Ie extends w{constructor(e){super(e)}render(e){e.innerHTML=Ce,this.initializeCommonElements(),this.initializeInputs(["waist","height"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.waistToHeightRatio}}class Se extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new Ie(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateIWaistHeightRatioFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),height:parseFloat(t.get("height"))}}updateView(){const t=this.calculator.getWaistToHeightRatio(),i={waistToHeightRatio:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return t.toFixed(2)}}const Me=`
<section class="container">
...
`;class Re extends w{constructor(t){super(t);l(this,"hipInputGroup",null)}render(t){t.innerHTML=Me,this.initializeCommonElements(),this.initializeInputs(["height","weight","waist","hip","neck"]),this.initializeSelectField("unitSystem"),this.hipInputGroup=this.getHipInputGroup()}bindGenderChange(t){document.querySelectorAll('input[name="gender"]').forEach(r=>{r.addEventListener("change",o=>{const n=o.target;t(n.value)})})}setGenderSelection(t){const i=document.querySelector(`input[value="${t}"]`);i&&(i.checked=!0)}toggleHipInputVisibility(t){this.hipInputGroup&&(this.hipInputGroup.style.display=t?"block":"none")}clearHipInput(){const t=this.inputs.get("hip");t&&(t.value="")}getHipInputGroup(){const t=this.inputs.get("hip");return(t==null?void 0:t.closest(".input-group"))||null}updateResults(t){if(!this.resultsTable)return;const i=this.resultsTable.rows;i[0].cells[1].textContent=t.bodyFatPercentage,i[1].cells[1].textContent=t.leanBodyMass}}var y=(a=>(a.MALE="male",a.FEMALE="female",a))(y||{});class Fe extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new Re(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.view.bindGenderChange(this.handleGenderChange.bind(this));const i=this.user.getData();this.fillFormData(i),i.gender?this.handleGenderChange(i.gender):this.view.toggleHipInputVisibility(!1),this.bindFormEvents(this.handleCalculate.bind(this))}handleGenderChange(t){const i=t===y.FEMALE;this.view.toggleHipInputVisibility(i),i||this.view.clearHipInput()}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateIBodyFatPercentageFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){const i={unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),waist:parseFloat(t.get("waist")),neck:parseFloat(t.get("neck"))};if(i.gender===y.FEMALE){const r=t.get("hip");if(r)i.hip=parseFloat(r);else throw new Error("Hip measurement is required for females.")}return i}updateView(){const t=this.calculator.getBodyFatPercentage(),i=this.calculator.getLeanBodyMass(),r=b.isImperial(this.getUnitSystemValue()),o={bodyFatPercentage:b.formatBodyFat(t),leanBodyMass:b.formatLeanMass(i,r)};this.view.updateResults(o)}}var h=(a=>(a.SEDENTARY="sedentary",a.LIGHTLY="lightly",a.MODERATELY="moderately",a.VERY="very",a.EXTREMELY="extremely",a))(h||{});const He=`
  <section class="container">
...
`;class We extends w{constructor(e){super(e)}render(e){e.innerHTML=He,this.initializeCommonElements(),this.initializeInputs(["weight","height","age"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.totalDailyEnergyExpenditureHarris,t[1].cells[1].textContent=e.totalDailyEnergyExpenditureMifflin}}class Ae extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new We(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateITotalDailyEnergyExpenditureFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age")),activityLevel:t.get("activityLevel")}}updateView(){const t=this.calculator.getTdeeHarrisBenedict(),i=this.calculator.getTdeeMifflinStJeor(),r={totalDailyEnergyExpenditureHarris:this.formatValue(t),totalDailyEnergyExpenditureMifflin:this.formatValue(i)};this.view.updateResults(r)}formatValue(t){return`${t.toFixed(0)} kcal/day`}}const Be=`
  <section class="container">
...
`;class $e extends w{constructor(e){super(e)}render(e){e.innerHTML=Be,this.initializeCommonElements(),this.initializeInputs(["weight","height","age"]),this.initializeSelectFields(["unitSystem","gender"])}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.basalMetabolicRateHarrisBenedict,t[1].cells[1].textContent=e.basalMetabolicRateMifflinStJeor}initializeSelectFields(e){e.forEach(t=>this.initializeSelectField(t))}}class Ge extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new $e(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateIBasalMetabolicRateFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){const i={unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age"))};if(!Object.values(y).includes(i.gender))throw new Error("Invalid gender value");return i}updateView(){const t=this.calculator.getBmrHarrisBenedict(),i=this.calculator.getBmrMifflinStJeor(),r={basalMetabolicRateHarrisBenedict:this.formatValue(t),basalMetabolicRateMifflinStJeor:this.formatValue(i)};this.view.updateResults(r)}formatValue(t){return`${t.toFixed(0)} kcal/day`}}const Le=`
  <section class="container">
...
`;class Oe extends w{constructor(e){super(e)}render(e){e.innerHTML=Le,this.initializeCommonElements(),this.initializeInputs(["weight","height","age","weightGoal","dailyCalories"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.weeksToWeightGoal}}class _e extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new Oe(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateITotalDailyEnergyExpenditureFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age")),activityLevel:t.get("activityLevel"),weightGoal:parseFloat(t.get("weightGoal")),dailyCalories:parseFloat(t.get("dailyCalories"))}}updateView(){const t=this.calculator.getEstimateTimeToWeightGoal(),i={weeksToWeightGoal:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return`${t.toFixed(1)} weeks`}}const Ve=`
  <section class="container">
...
`;class ke extends w{constructor(e){super(e)}render(e){e.innerHTML=Ve,this.initializeCommonElements(),this.initializeInputs(["weight","height","age","weightGoal","weeksToWeightGoal"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.dailyCalories}}class xe extends E{constructor(t,i,r){super(t,i,r);l(this,"view");this.view=new ke(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){const t=document.querySelector("select#unitSystem");return t?t.value:c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateITotalDailyEnergyExpenditureFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age")),activityLevel:t.get("activityLevel"),weightGoal:parseFloat(t.get("weightGoal")),weeksToWeightGoal:parseFloat(t.get("weeksToWeightGoal"))}}updateView(){const t=this.calculator.getCaloriesForWeightGoal(),i={dailyCalories:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return`${t.toFixed(0)} kcal/day`}}class F{validateNumericInput(e,t){if(typeof e!="number"||isNaN(e)||e<=0)throw new Error(`Invalid ${t} value`)}getConvertedLimits(e){const{min:t,max:i,shouldConvert:r,conversionFactor:o}=e;return r?{min:Math.round(t*o),max:Math.round(i*o)}:{min:t,max:i}}validateRange(e){const{value:t,min:i,max:r,name:o,unit:n}=e;if(t<i||t>r)throw new Error(`${o} must be between ${i} and ${r} ${n}`)}}const Ne=2.54,I={POUNDS:2.20462,FEET:3.28084,INCHES:1/Ne},f={METRIC:{WEIGHT:"kg",HEIGHT:"m",MEASUREMENT:"cm"},IMPERIAL:{WEIGHT:"lbs",HEIGHT:"ft",MEASUREMENT:"inches"}},g={weight:{min:20,max:500},height:{min:.5,max:2.5},age:{min:18,max:120},waist:{min:40,max:200},hip:{min:50,max:200},neck:{min:20,max:80},calories:{min:500,max:1e4},weeksToWeightGoal:{min:1,max:520}};class De extends F{validateWeight(e,t){this.validateNumericInput(e,"Weight");const i=t===c.IMPERIAL,{min:r,max:o}=this.getConvertedLimits({min:g.weight.min,max:g.weight.max,shouldConvert:i,conversionFactor:I.POUNDS});this.validateRange({value:e,min:r,max:o,name:"Weight",unit:i?f.IMPERIAL.WEIGHT:f.METRIC.WEIGHT})}validateHeight(e,t){this.validateNumericInput(e,"Height");const i=t===c.IMPERIAL,{min:r,max:o}=this.getConvertedLimits({min:g.height.min,max:g.height.max,shouldConvert:i,conversionFactor:I.FEET});this.validateRange({value:e,min:r,max:o,name:"Height",unit:i?f.IMPERIAL.HEIGHT:f.METRIC.HEIGHT})}validateBodyMeasurement(e,t,i){this.validateNumericInput(e,t);const r=i===c.IMPERIAL,{min:o,max:n}=this.getConvertedLimits({min:g[t].min,max:g[t].max,shouldConvert:r,conversionFactor:I.INCHES});this.validateRange({value:e,min:o,max:n,name:t.charAt(0).toUpperCase()+t.slice(1),unit:r?f.IMPERIAL.MEASUREMENT:f.METRIC.MEASUREMENT})}}class Pe extends F{validateAge(e){this.validateNumericInput(e,"Age");const t=g.age;if(e<t.min||e>t.max)throw new Error(`Age must be between ${t.min} and ${t.max} years`)}validateGender(e){if(!Object.values(y).includes(e))throw new Error("Invalid gender value")}validateActivityLevel(e){if(!Object.values(h).includes(e))throw new Error("Invalid activity level value")}validateUnitSystem(e){if(!Object.values(c).includes(e))throw new Error("Invalid unit system value")}}class Ue extends F{validateWeightGoal(e,t){this.validateNumericInput(e,"Weight goal");const i=t===c.IMPERIAL,{min:r,max:o}=this.getConvertedLimits({min:g.weight.min,max:g.weight.max,shouldConvert:i,conversionFactor:I.POUNDS});this.validateRange({value:e,min:r,max:o,name:"Weight goal",unit:i?f.IMPERIAL.WEIGHT:f.METRIC.WEIGHT})}validateWeeksToWeightGoal(e){this.validateNumericInput(e,"Weeks to weight goal"),this.validateRange({value:e,min:g.weeksToWeightGoal.min,max:g.weeksToWeightGoal.max,name:"Weeks to goal",unit:"weeks"})}validateDailyCalories(e){this.validateNumericInput(e,"Daily calories"),this.validateRange({value:e,min:g.calories.min,max:g.calories.max,name:"Daily calories",unit:"calories"})}}class Je{constructor(){l(this,"measurementValidator");l(this,"personalInfoValidator");l(this,"goalValidator");this.measurementValidator=new De,this.personalInfoValidator=new Pe,this.goalValidator=new Ue}validateIBmiFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem)}validateITotalDailyEnergyExpenditureFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age),this.personalInfoValidator.validateActivityLevel(e.activityLevel)}validateWaistToHipRatioFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.hip,"hip",e.unitSystem)}validateIWaistHeightRatioFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem)}validateIBodyFatPercentageFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.neck,"neck",e.unitSystem),e.gender===y.FEMALE&&e.hip!==void 0&&this.measurementValidator.validateBodyMeasurement(e.hip,"hip",e.unitSystem)}validateIBasalMetabolicRateFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age)}validateICaloriesForWeightGoalFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age),this.personalInfoValidator.validateActivityLevel(e.activityLevel),this.goalValidator.validateWeightGoal(e.weightGoal,e.unitSystem),this.goalValidator.validateWeeksToWeightGoal(e.weeksToWeightGoal)}validateIEstimateTimeToWeightGoalFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.personalInfoValidator.validateActivityLevel(e.activityLevel),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age),this.goalValidator.validateDailyCalories(e.dailyCalories),this.goalValidator.validateWeightGoal(e.weightGoal,e.unitSystem)}}class Ye{constructor(e,t){l(this,"formValidator");this.user=e,this.calculator=t,this.formValidator=new Je}createController(e){const i={HOME:()=>this.createHomeController(),BMI:()=>this.createBmiController(),WAIST_TO_HIP:()=>this.createWaistToHipController(),WAIST_TO_HEIGHT:()=>this.createWaistToHeightController(),BODY_FAT:()=>this.createBodyFatController(),BMR:()=>this.createBmrController(),TDEE:()=>this.createTdeeController(),WEIGHT_GOAL:()=>this.createWeightGoalController(),CALORIE_GOAL:()=>this.createCalorieGoalController()}[e];if(!i)throw new Error(`No controller found for route: ${e}`);return i()}createHomeController(){return new x}createBmiController(){return new we(this.user,this.calculator,this.formValidator)}createWaistToHipController(){return new be(this.user,this.calculator,this.formValidator)}createWaistToHeightController(){return new Se(this.user,this.calculator,this.formValidator)}createBodyFatController(){return new Fe(this.user,this.calculator,this.formValidator)}createBmrController(){return new Ge(this.user,this.calculator,this.formValidator)}createTdeeController(){return new Ae(this.user,this.calculator,this.formValidator)}createWeightGoalController(){return new _e(this.user,this.calculator,this.formValidator)}createCalorieGoalController(){return new xe(this.user,this.calculator,this.formValidator)}}class qe{constructor(e,t){l(this,"currentController",null);l(this,"controllerFactory");this.controllerFactory=new Ye(e,t)}listen(){window.addEventListener("hashchange",()=>{const t=window.location.hash.slice(1);this.navigate(t)});const e=window.location.hash.slice(1)||"/";this.navigate(e)}navigate(e){const t=document.getElementById("app");if(!t)return;t.innerHTML="";const i=_(e);if(i!==void 0)try{this.currentController=this.controllerFactory.createController(i),this.currentController.init(t)}catch{t.innerHTML="<h2>An error occurred</h2>"}else t.innerHTML="<h2>404 Not Found</h2>"}}class ze{constructor(){l(this,"data");const e=sessionStorage.getItem("userModel");this.data=e?JSON.parse(e):{unitSystem:"metric"}}setData(e){Object.assign(this.data,e),this.saveToSession()}getData(){return{weight:this.data.weight,height:this.data.height,unitSystem:this.data.unitSystem,age:this.data.age,gender:this.data.gender,waist:this.data.waist,hip:this.data.hip,neck:this.data.neck,activityLevel:this.data.activityLevel,dailyCalories:this.data.dailyCalories,weightGoal:this.data.weightGoal,weeksToWeightGoal:this.data.weeksToWeightGoal}}resetData(){this.data={unitSystem:c.METRIC},this.saveToSession()}saveToSession(){sessionStorage.setItem("userModel",JSON.stringify(this.data))}}class Ke{constructor(){l(this,"dropdownToggles");l(this,"dropdownMenus");this.dropdownToggles=Array.from(document.querySelectorAll(".dropdown-toggle")),this.dropdownMenus=Array.from(document.querySelectorAll(".dropdown-menu")),this.initializeDropdowns()}initializeDropdowns(){this.dropdownToggles.forEach(e=>{e.addEventListener("click",this.toggleDropdown.bind(this))}),document.addEventListener("click",this.handleOutsideClick.bind(this))}toggleDropdown(e){var r;e.preventDefault(),this.dropdownMenus.forEach(o=>{var n;(n=o.parentElement)==null||n.classList.remove("show")});const t=e.currentTarget,i=t.nextElementSibling;i&&i.classList.contains("dropdown-menu")&&((r=t.parentElement)==null||r.classList.toggle("show"))}handleOutsideClick(e){const t=e.target;this.dropdownToggles.some(r=>r.contains(t))||this.dropdownMenus.forEach(r=>{var o;(o=r.parentElement)==null||o.classList.remove("show")})}}class je{constructor(){l(this,"router");l(this,"user");l(this,"calculator");this.user=new ze,this.calculator=new fe(this.user),this.router=new qe(this.user,this.calculator),new Ke}start(){this.router.listen();const e=window.location.hash.slice(1)||"/";this.router.navigate(e)}}const Xe=new je;Xe.start();

var H=Object.defineProperty;var B=(i,e,t)=>e in i?H(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var n=(i,e,t)=>(B(i,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();var m=(i=>(i[i.HOME=0]="HOME",i[i.BMI=1]="BMI",i[i.BASAL_METABOLIC_RATE=2]="BASAL_METABOLIC_RATE",i[i.TDEE=3]="TDEE",i[i.BODY_COMPOSITION=4]="BODY_COMPOSITION",i[i.CALORIE_CALCULATION=5]="CALORIE_CALCULATION",i[i.WAIST_TO_HIP=6]="WAIST_TO_HIP",i[i.WAIST_TO_HEIGHT=7]="WAIST_TO_HEIGHT",i[i.BODY_FAT_PERCENTAGE=8]="BODY_FAT_PERCENTAGE",i))(m||{});const F={0:"/",1:"/bmi",2:"/bmr",3:"/tdee",4:"/body-composition",5:"/calorie-calculation",6:"/waist-to-hip",7:"/waist-to-height",8:"/body-fat-percentage"};function W(i){const e=Object.entries(F).find(([t,a])=>a===i);return e?Number(e[0]):void 0}var p=(i=>(i.BMI="bmi",i.BMR="bmr",i.TDEE="tdee",i.BODY_COMPOSITION="body-composition",i.CALORIE_CALCULATION="calorie-calculation",i))(p||{});class O{render(e){e.innerHTML=`
        <section class="container">
          <h2>Our Calculators</h2>
          ${this.renderCalculatorItems()}
        </section>
      `}renderCalculatorItems(){return Object.values(p).map(e=>`
      ...
      `).join("")}getCalculatorDescription(e){return{[p.BMI]:"Body Mass Index (BMI) - A measure of body fat based on weight and height.",[p.BMR]:"Basal Metabolic Rate (BMR) - The amount of energy your body needs to maintain basic functions while at rest.",[p.TDEE]:"Total Daily Energy Expenditure (TDEE) - The number of calories you burn daily, including activities and exercise.",[p.BODY_COMPOSITION]:"Body Composition - Calculate body fat percentage, waist-to-hip ratio, and lean body mass.",[p.CALORIE_CALCULATION]:"Calorie Calculations - Estimate daily calorie needs to reach your weight goal, and predict weight change based on your caloric intake."}[e]||"Description not available."}}class _{constructor(){n(this,"view");this.view=new O}init(e){this.view.render(e)}}class v{constructor(){n(this,"form",null);n(this,"resultsTable",null);n(this,"errorMessage",null);n(this,"inputs",{})}initializeCommonElements(){this.form=this.getElement("form"),this.resultsTable=this.getElement(".results table"),this.errorMessage=this.getElement(".error-message")}initializeInputs(e){e.forEach(t=>{this.inputs[t]=this.getElement(`#${t}`)})}resetForm(){var e;(e=this.form)==null||e.reset(),this.clearResults(),this.updatePlaceholders(),this.hideError()}clearResults(){if(this.resultsTable){const e=this.resultsTable.rows;for(let t=0;t<e.length;t++)e[t].cells[1].textContent="-"}}updatePlaceholders(){}showError(e){this.errorMessage instanceof HTMLElement&&(this.errorMessage.textContent=e,this.errorMessage.classList.remove("hidden"))}hideError(){this.errorMessage instanceof HTMLElement&&(this.errorMessage.textContent="",this.errorMessage.classList.add("hidden"))}getElement(e){return document.querySelector(e)}createElement(e,t){const a=document.createElement(e);return t&&(a.className=t),a}bindResetEvent(e){var a;const t=(a=this.form)==null?void 0:a.querySelector('button[type="reset"]');t==null||t.addEventListener("click",s=>{s.preventDefault(),e()})}}var g=(i=>(i.METRIC="metric",i.IMPERIAL="imperial",i))(g||{});const L=`
      <section class="container">
    ...
    `;var u=(i=>(i.WEIGHT="#weight",i.HEIGHT="#height",i.WAIST="#waist",i.NECK="#neck",i.HIP="#hip",i.AGE="#age",i.UNIT_SYSTEM="#unitSystem",i.RESULT_TABLE=".resultTable",i.ERROR_MESSAGE=".errorMessage",i.FORM="form",i))(u||{}),w=(i=>(i.WEIGHT="weight",i.HEIGHT="height",i.WAIST="waist",i.NECK="neck",i.HIP="hip",i.AGE="age",i))(w||{});class G extends v{constructor(){super(...arguments);n(this,"heightInput",null);n(this,"weightInput",null);n(this,"unitSystemSelect",null)}render(t){var a;t.innerHTML=L,this.initializeCommonElements(),this.initializeInputs([w.HEIGHT,w.WEIGHT]),this.weightInput=this.getElement(u.WEIGHT),this.heightInput=this.getElement(u.HEIGHT),this.unitSystemSelect=this.getElement(u.UNIT_SYSTEM),(a=this.unitSystemSelect)==null||a.addEventListener("change",this.updatePlaceholders.bind(this))}fillForm(t){this.unitSystemSelect&&t.unitSystem&&(this.unitSystemSelect.value=t.unitSystem),this.setInputValue(this.heightInput,t.height),this.setInputValue(this.weightInput,t.weight),this.updatePlaceholders()}setInputValue(t,a){t&&a&&(t.value=a.toString())}updatePlaceholders(){var s;const a=((s=this.unitSystemSelect)==null?void 0:s.value)===g.IMPERIAL?{height:"ft",weight:"lbs"}:{height:"m",weight:"kg"};Object.keys(this.inputs).forEach(r=>{this.inputs[r].setAttribute("placeholder",a[r])})}bindCalculateEvent(t){var a;(a=this.form)==null||a.addEventListener("submit",s=>{s.preventDefault();const r=new FormData(this.form);t(r)})}updateResults(t){if(!this.resultsTable)return;const a=this.resultsTable.rows;a[0].cells[1].textContent=t.bmi.toFixed(2),a[1].cells[1].textContent=t.category,a[2].cells[1].textContent=t.healthRisk,a[3].cells[1].textContent=`${t.idealWeight[0].toFixed(0)} - ${t.idealWeight[1].toFixed(0)} kg`}}/**
 * @license
...
`;class me extends v{constructor(){super(...arguments);n(this,"waistInput",null);n(this,"hipInput",null);n(this,"unitSystemSelect",null)}render(t){var a;t.innerHTML=ge,this.initializeCommonElements(),this.initializeInputs(["waist","hip"]),this.waistInput=this.getElement("#waist"),this.hipInput=this.getElement("#hip"),this.unitSystemSelect=this.getElement("#unitSystem"),(a=this.unitSystemSelect)==null||a.addEventListener("change",this.updatePlaceholders.bind(this))}fillForm(t){this.unitSystemSelect&&t.unitSystem&&(this.unitSystemSelect.value=t.unitSystem),this.waistInput&&t.waist&&(this.waistInput.value=t.waist.toString()),this.hipInput&&t.hip&&(this.hipInput.value=t.hip.toString()),this.updatePlaceholders()}updatePlaceholders(){var s;const a=((s=this.unitSystemSelect)==null?void 0:s.value)===g.IMPERIAL?{waist:"in",hip:"in"}:{waist:"cm",hip:"cm"};Object.keys(this.inputs).forEach(r=>{this.inputs[r].setAttribute("placeholder",a[r])})}bindCalculateEvent(t){var a;(a=this.form)==null||a.addEventListener("submit",s=>{s.preventDefault();const r=new FormData(this.form);t(r)})}updateResults(t){if(this.resultsTable){const a=this.resultsTable.querySelector("td:nth-child(2)");a&&(a.textContent=t.toFixed(2))}}}class pe extends E{constructor(t,a){super(t,a);n(this,"view");n(this,"formValidator");this.view=new me,this.formValidator=new T}init(t){this.view.render(t),this.fillFormWithUserData(),this.view.bindCalculateEvent(this.handleCalculate.bind(this)),this.view.bindResetEvent(this.handleReset.bind(this))}fillFormWithUserData(){const t=this.user.getData();this.view.fillForm(t)}handleCalculate(t){try{console.log("handleCalculate called with:",t);const a=this.parseFormData(t);this.formValidator.validateWaistToHipRatioFormData(a),this.user.setData(a),this.updateView(),this.view.hideError()}catch(a){this.handleErrors(a)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),hip:parseFloat(t.get("hip"))}}updateView(){const t=this.calculator.getWaistToHipRatio();console.log("Ratio:",t),this.view.updateResults(t)}handleReset(){this.user.resetData(),this.view.resetForm(),this.view.hideError()}}const fe=`
<section class="container">
...
`;class we extends v{constructor(){super(...arguments);n(this,"waistInput",null);n(this,"heightInput",null);n(this,"unitSystemSelect",null)}render(t){var a;t.innerHTML=fe,this.initializeCommonElements(),this.initializeInputs(["waist","height"]),this.waistInput=this.getElement("#waist"),this.heightInput=this.getElement("#height"),this.unitSystemSelect=this.getElement("#unitSystem"),(a=this.unitSystemSelect)==null||a.addEventListener("change",this.updatePlaceholders.bind(this))}fillForm(t){this.unitSystemSelect&&t.unitSystem&&(this.unitSystemSelect.value=t.unitSystem),this.waistInput&&t.waist&&(this.waistInput.value=t.waist.toString()),this.heightInput&&t.height&&(this.heightInput.value=t.height.toString()),this.updatePlaceholders()}updatePlaceholders(){var s;const a=((s=this.unitSystemSelect)==null?void 0:s.value)===g.IMPERIAL?{waist:"in",hip:"in"}:{waist:"cm",hip:"cm"};Object.keys(this.inputs).forEach(r=>{this.inputs[r].setAttribute("placeholder",a[r])})}bindCalculateEvent(t){var a;(a=this.form)==null||a.addEventListener("submit",s=>{s.preventDefault();const r=new FormData(this.form);t(r)})}updateResults(t){if(this.resultsTable){const a=this.resultsTable.querySelector("td:nth-child(2)");a&&(a.textContent=t.toFixed(2))}}}class ye extends E{constructor(t,a){super(t,a);n(this,"view");n(this,"formValidator");this.view=new we,this.formValidator=new T}init(t){this.view.render(t),this.fillFormWithUserData(),this.view.bindCalculateEvent(this.handleCalculate.bind(this)),this.view.bindResetEvent(this.handleReset.bind(this))}fillFormWithUserData(){const t=this.user.getData();this.view.fillForm(t)}handleCalculate(t){try{console.log("handleCalculate called with:",t);const a=this.parseFormData(t);this.formValidator.validateWaistHeightRatioFormData(a),this.user.setData(a),this.updateView(),this.view.hideError()}catch(a){this.handleErrors(a)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),height:parseFloat(t.get("height"))}}updateView(){const t=this.calculator.getWaistToHeightRatio();this.view.updateResults(t)}handleReset(){this.user.resetData(),this.view.resetForm(),this.view.hideError()}}const ve=`
<section class="container">
...
`;class Ee extends v{constructor(){super(...arguments);n(this,"weightInput",null);n(this,"waistInput",null);n(this,"hipInput",null);n(this,"neckInput",null);n(this,"unitSystemSelect",null);n(this,"genderInputs",[])}render(t){var s,r;t.innerHTML=ve,this.initializeCommonElements(),this.initializeInputs(["weight","waist","hip","neck"]),this.weightInput=this.getElement("#weight"),this.waistInput=this.getElement("#waist"),this.hipInput=this.getElement("#hip"),this.neckInput=this.getElement("#neck"),this.unitSystemSelect=this.getElement("#unitSystem");const a=(s=this.form)==null?void 0:s.querySelectorAll('input[name="gender"]');this.genderInputs=Array.from(a||[]),(r=this.unitSystemSelect)==null||r.addEventListener("change",this.updatePlaceholders.bind(this)),this.genderInputs.forEach(l=>{l.addEventListener("change",this.updateHipInputVisibility.bind(this))}),this.updateHipInputVisibility()}fillForm(t){this.unitSystemSelect&&t.unitSystem&&(this.unitSystemSelect.value=t.unitSystem),this.setInputValue(this.weightInput,t.weight),this.setInputValue(this.waistInput,t.waist),this.setInputValue(this.neckInput,t.neck),t.gender&&(this.setGender(t.gender),this.handleHipInput(t)),this.updatePlaceholders(),this.updateHipInputVisibility()}setInputValue(t,a){t&&a!==void 0&&(t.value=a.toString())}setGender(t){const a=this.genderInputs.find(s=>s.value===t);a&&(a.checked=!0)}handleHipInput(t){this.hipInput&&t.hip&&t.gender===y.FEMALE&&(this.hipInput.value=t.hip.toString())}updatePlaceholders(){var s;const a=((s=this.unitSystemSelect)==null?void 0:s.value)===g.IMPERIAL?{weight:"lbs",waist:"in",hip:"in",neck:"in"}:{weight:"kg",waist:"cm",hip:"cm",neck:"cm"};Object.keys(this.inputs).forEach(r=>{this.inputs[r].setAttribute("placeholder",a[r])})}updateHipInputVisibility(){var s;const t=this.getElement(".input-group:has(#hip)"),a=(s=this.getElement('input[value="female"]'))==null?void 0:s.checked;t&&(t.style.display=a?"block":"none")}bindCalculateEvent(t){var a;(a=this.form)==null||a.addEventListener("submit",s=>{s.preventDefault();const r=new FormData(this.form);t(r)})}updateResults(t){if(!this.resultsTable)return;const a=this.resultsTable.rows;a[0].cells[1].textContent=t.bodyFatPercentage.toFixed(2)+"%",a[1].cells[1].textContent=t.leanBodyMass.toFixed(2)+" kg"}}class Te extends E{constructor(t,a){super(t,a);n(this,"view");n(this,"formValidator");this.view=new Ee,this.formValidator=new T}init(t){this.view.render(t),this.fillFormWithUserData(),this.view.bindCalculateEvent(this.handleCalculate.bind(this)),this.view.bindResetEvent(this.handleReset.bind(this))}fillFormWithUserData(){const t=this.user.getData();this.view.fillForm(t)}handleCalculate(t){try{console.log("handleCalculate called with:",t);const a=this.parseFormData(t);this.formValidator.validateBodyFatPercentageFormData(a),this.user.setData(a),this.updateView(),this.view.hideError()}catch(a){this.handleErrors(a)}}parseFormData(t){const a={unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),waist:parseFloat(t.get("waist")),neck:parseFloat(t.get("neck"))};if(a.gender===y.FEMALE){const s=t.get("hip");if(s)a.hip=parseFloat(s);else throw new Error("Hip measurement is required for females.")}return a}updateView(){const t=this.calculator.getBodyFatPercentage(),a=this.calculator.getLeanBodyMass();this.view.updateResults({bodyFatPercentage:t,leanBodyMass:a})}handleReset(){this.user.resetData(),this.view.resetForm(),this.view.hideError()}}const Ie=`
  <section class="container">

var B=Object.defineProperty;var $=(a,e,t)=>e in a?B(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var n=(a,e,t)=>($(a,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(r){if(r.ep)return;r.ep=!0;const l=t(r);fetch(r.href,l)}})();const G={HOME:"/"},A={BMI:"/bmi",BMR:"/bmr",TDEE:"/tdee",WAIST_TO_HIP:"/waist-to-hip",WAIST_TO_HEIGHT:"/waist-to-height",BODY_FAT:"/body-fat-percentage",CALORIE_GOAL:"/calorie-goal",WEIGHT_GOAL:"/weight-goal"},L={...G,...A};function O(a){const t=Object.entries(L).find(([i,r])=>r===a);return t?t[0]:void 0}const V={BMI:"Body Mass Index (BMI) - A measure of body fat based on weight and height.",BMR:"Basal Metabolic Rate (BMR) - The amount of energy your body needs to maintain basic functions while at rest.",TDEE:"Total Daily Energy Expenditure (TDEE) - The number of calories you burn daily.",WAIST_TO_HIP:"Calculate the ratio between your waist and hip circumference.",WAIST_TO_HEIGHT:"Calculate the ratio between your waist circumference and height.",BODY_FAT:"Estimate the percentage of fat in your body based on measurements.",CALORIE_GOAL:"Estimate daily calorie needs to reach your weight goal",WEIGHT_GOAL:"Calculate the time needed to reach your desired weight."};class k{render(e){e.innerHTML=`
...
`;class Ee extends f{constructor(e){super(e)}render(e){e.innerHTML=we,this.initializeCommonElements(),this.initializeInputs(["hip","waist"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.waistToHipRatio}}class Te extends w{constructor(t,i,r){super(t,i,r);n(this,"view");this.view=new Ee(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateWaistToHipRatioFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),hip:parseFloat(t.get("hip"))}}updateView(){const t=this.calculator.getWaistToHipRatio(),i={waistToHipRatio:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return t.toFixed(2)}}const be=`
<section class="container">
...
`;class Ce extends f{constructor(e){super(e)}render(e){e.innerHTML=be,this.initializeCommonElements(),this.initializeInputs(["waist","height"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.waistToHeightRatio}}class Ie extends w{constructor(t,i,r){super(t,i,r);n(this,"view");this.view=new Ce(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateWaistHeightRatioFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),height:parseFloat(t.get("height"))}}updateView(){const t=this.calculator.getWaistToHeightRatio(),i={waistToHeightRatio:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return t.toFixed(2)}}const Se=`
<section class="container">
...
`;class ke extends f{constructor(e){super(e)}render(e){e.innerHTML=Ve,this.initializeCommonElements(),this.initializeInputs(["weight","height","age","weightGoal","weeksToWeightGoal"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.dailyCalories}}class _e extends w{constructor(t,i,r){super(t,i,r);n(this,"view");this.view=new ke(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateTotalDailyEnergyExpenditureFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age")),activityLevel:t.get("activityLevel"),weightGoal:parseFloat(t.get("weightGoal")),weeksToWeightGoal:parseFloat(t.get("weeksToWeightGoal"))}}updateView(){const t=this.calculator.getCaloriesForWeightGoal(),i={dailyCalories:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return`${t.toFixed(0)} kcal/day`}}class M{validateNumericInput(e,t){if(typeof e!="number"||isNaN(e)||e<=0)throw new Error(`Invalid ${t} value`)}getConvertedLimits(e){const{min:t,max:i,shouldConvert:r,conversionFactor:l}=e;return r?{min:Math.round(t*l),max:Math.round(i*l)}:{min:t,max:i}}validateRange(e){const{value:t,min:i,max:r,name:l,unit:o}=e;if(t<i||t>r)throw new Error(`${l} must be between ${i} and ${r} ${o}`)}}const b={POUNDS:2.20462,FEET:3.28084,INCHES:1/2.54},v={METRIC:{WEIGHT:"kg",HEIGHT:"m",MEASUREMENT:"cm"},IMPERIAL:{WEIGHT:"lbs",HEIGHT:"ft",MEASUREMENT:"inches"}},d={weight:{min:20,max:500},height:{min:.5,max:2.5},age:{min:18,max:120},waist:{min:40,max:200},hip:{min:50,max:200},neck:{min:20,max:80},calories:{min:500,max:1e4},weeksToWeightGoal:{min:1,max:520}};class xe extends M{validateWeight(e,t){this.validateNumericInput(e,"Weight");const i=t===c.IMPERIAL,{min:r,max:l}=this.getConvertedLimits({min:d.weight.min,max:d.weight.max,shouldConvert:i,conversionFactor:b.POUNDS});this.validateRange({value:e,min:r,max:l,name:"Weight",unit:i?v.IMPERIAL.WEIGHT:v.METRIC.WEIGHT})}validateHeight(e,t){this.validateNumericInput(e,"Height");const i=t===c.IMPERIAL,{min:r,max:l}=this.getConvertedLimits({min:d.height.min,max:d.height.max,shouldConvert:i,conversionFactor:b.FEET});this.validateRange({value:e,min:r,max:l,name:"Height",unit:i?v.IMPERIAL.HEIGHT:v.METRIC.HEIGHT})}validateBodyMeasurement(e,t,i){this.validateNumericInput(e,t);const r=i===c.IMPERIAL,{min:l,max:o}=this.getConvertedLimits({min:d[t].min,max:d[t].max,shouldConvert:r,conversionFactor:b.INCHES});this.validateRange({value:e,min:l,max:o,name:t.charAt(0).toUpperCase()+t.slice(1),unit:r?v.IMPERIAL.MEASUREMENT:v.METRIC.MEASUREMENT})}}class De extends M{validateAge(e){this.validateNumericInput(e,"Age");const t=d.age;if(e<t.min||e>t.max)throw new Error(`Age must be between ${t.min} and ${t.max} years`)}validateGender(e){if(!Object.values(p).includes(e))throw new Error("Invalid gender value")}validateActivityLevel(e){if(!Object.values(h).includes(e))throw new Error("Invalid activity level value")}validateUnitSystem(e){if(!Object.values(c).includes(e))throw new Error("Invalid unit system value")}}class Ne extends M{validateWeightGoal(e,t){this.validateNumericInput(e,"Weight goal");const i=t===c.IMPERIAL,{min:r,max:l}=this.getConvertedLimits({min:d.weight.min,max:d.weight.max,shouldConvert:i,conversionFactor:b.POUNDS});this.validateRange({value:e,min:r,max:l,name:"Weight goal",unit:i?v.IMPERIAL.WEIGHT:v.METRIC.WEIGHT})}validateWeeksToWeightGoal(e){this.validateNumericInput(e,"Weeks to weight goal"),this.validateRange({value:e,min:d.weeksToWeightGoal.min,max:d.weeksToWeightGoal.max,name:"Weeks to goal",unit:"weeks"})}validateDailyCalories(e){this.validateNumericInput(e,"Daily calories"),this.validateRange({value:e,min:d.calories.min,max:d.calories.max,name:"Daily calories",unit:"calories"})}}class Pe{constructor(){n(this,"measurementValidator");n(this,"personalInfoValidator");n(this,"goalValidator");this.measurementValidator=new xe,this.personalInfoValidator=new De,this.goalValidator=new Ne}validateBmiFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem)}validateTotalDailyEnergyExpenditureFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age),this.personalInfoValidator.validateActivityLevel(e.activityLevel)}validateWaistToHipRatioFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.hip,"hip",e.unitSystem)}validateWaistHeightRatioFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem)}validateBodyFatPercentageFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.measurementValidator.validateBodyMeasurement(e.neck,"neck",e.unitSystem),e.gender===p.FEMALE&&e.hip!==void 0&&this.measurementValidator.validateBodyMeasurement(e.hip,"hip",e.unitSystem)}validateBasalMetabolicRateFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age)}validateCaloriesForWeightGoalFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age),this.personalInfoValidator.validateActivityLevel(e.activityLevel),this.goalValidator.validateWeightGoal(e.weightGoal,e.unitSystem),this.goalValidator.validateWeeksToWeightGoal(e.weeksToWeightGoal)}validateEstimateTimeToWeightGoalFormData(e){this.personalInfoValidator.validateUnitSystem(e.unitSystem),this.personalInfoValidator.validateGender(e.gender),this.personalInfoValidator.validateActivityLevel(e.activityLevel),this.measurementValidator.validateWeight(e.weight,e.unitSystem),this.measurementValidator.validateHeight(e.height,e.unitSystem),this.personalInfoValidator.validateAge(e.age),this.goalValidator.validateDailyCalories(e.dailyCalories),this.goalValidator.validateWeightGoal(e.weightGoal,e.unitSystem)}}class Ue{constructor(e,t){n(this,"formValidator");this.user=e,this.calculator=t,this.formValidator=new Pe}createController(e){switch(e){case"HOME":return this.createHomeController();case"BMI":return this.createBmiController();case"WAIST_TO_HIP":return this.createWaistToHipController();case"WAIST_TO_HEIGHT":return this.createWaistToHeightController();case"BODY_FAT":return this.createBodyFatController();case"BMR":return this.createBmrController();case"TDEE":return this.createTdeeController();case"WEIGHT_GOAL":return this.createWeightGoalController();case"CALORIE_GOAL":return this.createCalorieGoalController();default:throw new Error(`No controller found for route: ${e}`)}}createHomeController(){return new _}createBmiController(){return new fe(this.user,this.calculator,this.formValidator)}createWaistToHipController(){return new Te(this.user,this.calculator,this.formValidator)}createWaistToHeightController(){return new Ie(this.user,this.calculator,this.formValidator)}createBodyFatController(){return new Re(this.user,this.calculator,this.formValidator)}createBmrController(){return new $e(this.user,this.calculator,this.formValidator)}createTdeeController(){return new Ae(this.user,this.calculator,this.formValidator)}createWeightGoalController(){return new Oe(this.user,this.calculator,this.formValidator)}createCalorieGoalController(){return new _e(this.user,this.calculator,this.formValidator)}}class Je{constructor(e,t){n(this,"currentController",null);n(this,"controllerFactory");this.controllerFactory=new Ue(e,t)}listen(){window.addEventListener("hashchange",()=>{const t=window.location.hash.slice(1);this.navigate(t)});const e=window.location.hash.slice(1)||"/";this.navigate(e)}navigate(e){const t=document.getElementById("app");if(!t)return;t.innerHTML="";const i=O(e);if(i!==void 0)try{this.currentController=this.controllerFactory.createController(i),this.currentController.init(t)}catch{t.innerHTML="<h2>An error occurred</h2>"}else t.innerHTML="<h2>404 Not Found</h2>"}}let S=null;class R{constructor(){n(this,"data");const e=sessionStorage.getItem("userModel");this.data=e?JSON.parse(e):{unitSystem:"metric"}}static getInstance(){return S||(S=new R),S}setData(e){Object.assign(this.data,e),this.saveToSession()}getData(){return{weight:this.data.weight,height:this.data.height,unitSystem:this.data.unitSystem,age:this.data.age,gender:this.data.gender,waist:this.data.waist,hip:this.data.hip,neck:this.data.neck,activityLevel:this.data.activityLevel,dailyCalories:this.data.dailyCalories,weightGoal:this.data.weightGoal,weeksToWeightGoal:this.data.weeksToWeightGoal}}resetData(){this.data={unitSystem:c.METRIC},this.saveToSession()}saveToSession(){sessionStorage.setItem("userModel",JSON.stringify(this.data))}}class Ye{constructor(){n(this,"dropdownToggles");n(this,"dropdownMenus");this.dropdownToggles=Array.from(document.querySelectorAll(".dropdown-toggle")),this.dropdownMenus=Array.from(document.querySelectorAll(".dropdown-menu")),this.initializeDropdowns()}initializeDropdowns(){this.dropdownToggles.forEach(e=>{e.addEventListener("click",this.toggleDropdown.bind(this))}),document.addEventListener("click",this.handleOutsideClick.bind(this))}toggleDropdown(e){var r;e.preventDefault(),this.dropdownMenus.forEach(l=>{var o;(o=l.parentElement)==null||o.classList.remove("show")});const t=e.currentTarget,i=t.nextElementSibling;i&&i.classList.contains("dropdown-menu")&&((r=t.parentElement)==null||r.classList.toggle("show"))}handleOutsideClick(e){const t=e.target;this.dropdownToggles.some(r=>r.contains(t))||this.dropdownMenus.forEach(r=>{var l;(l=r.parentElement)==null||l.classList.remove("show")})}}class qe{constructor(){n(this,"router");n(this,"user");n(this,"calculator");this.user=R.getInstance(),this.calculator=new ve(this.user),this.router=new Je(this.user,this.calculator),new Ye}start(){this.router.listen();const e=window.location.hash.slice(1)||"/";this.router.navigate(e)}}const ze=new qe;ze.start();

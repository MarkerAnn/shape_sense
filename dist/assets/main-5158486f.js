var H=Object.defineProperty;var A=(a,e,t)=>e in a?H(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var n=(a,e,t)=>(A(a,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(r){if(r.ep)return;r.ep=!0;const l=t(r);fetch(r.href,l)}})();const W={HOME:"/"},R={BMI:"/bmi",BMR:"/bmr",TDEE:"/tdee",WAIST_TO_HIP:"/waist-to-hip",WAIST_TO_HEIGHT:"/waist-to-height",BODY_FAT:"/body-fat-percentage",CALORIE_GOAL:"/calorie-goal",WEIGHT_GOAL:"/weight-goal"},B={...W,...R};function $(a){const t=Object.entries(B).find(([i,r])=>r===a);return t?t[0]:void 0}const L={BMI:"Body Mass Index (BMI) - A measure of body fat based on weight and height.",BMR:"Basal Metabolic Rate (BMR) - The amount of energy your body needs to maintain basic functions while at rest.",TDEE:"Total Daily Energy Expenditure (TDEE) - The number of calories you burn daily.",WAIST_TO_HIP:"Calculate the ratio between your waist and hip circumference.",WAIST_TO_HEIGHT:"Calculate the ratio between your waist circumference and height.",BODY_FAT:"Estimate the percentage of fat in your body based on measurements.",CALORIE_GOAL:"Estimate daily calorie needs to reach your weight goal",WEIGHT_GOAL:"Calculate the time needed to reach your desired weight."};class G{render(e){e.innerHTML=`
        <section class="container">
          <h2>Our Calculators</h2>
          ${this.renderCalculatorItems()}
        </section>
      `}renderCalculatorItems(){return Object.entries(R).map(([e,t])=>`
      ...
      `).join("")}formatDisplayText(e){return e.replace(/_/g," ").split(" ").map(t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase()).join(" ")}getCalculatorDescription(e){return L[e]??"Description not available."}}class O{constructor(){n(this,"view");this.view=new G}init(e){this.view.render(e)}}const s={weight:"weight",height:"height",age:"age",waist:"waist",hip:"hip",neck:"neck",weightGoal:"weightGoal",weeksToWeightGoal:"weeksToWeightGoal",dailyCalories:"dailyCalories",unitSystem:"unitSystem",gender:"gender",activityLevel:"activityLevel"},E={inputs:{weight:`#${s.weight}`,height:`#${s.height}`,age:`#${s.age}`,waist:`#${s.waist}`,hip:`#${s.hip}`,neck:`#${s.neck}`,weightGoal:`#${s.weightGoal}`,weeksToWeightGoal:`#${s.weeksToWeightGoal}`,dailyCalories:`#${s.dailyCalories}`},selects:{unitSystem:`#${s.unitSystem}`,gender:`#${s.gender}`,activityLevel:`#${s.activityLevel}`},common:{form:"form",resultTable:".resultTable",errorMessage:".errorMessage",inputGroup:".inputGroup"}},k={metric:{[s.height]:"m",[s.weight]:"kg",[s.waist]:"cm",[s.hip]:"cm",[s.neck]:"cm"},imperial:{[s.height]:"ft",[s.weight]:"lbs",[s.waist]:"in",[s.hip]:"in",[s.neck]:"in"}};class y{constructor(e){n(this,"form",null);n(this,"resultsTable",null);n(this,"errorMessage",null);n(this,"inputs",new Map);n(this,"selects",new Map);n(this,"getSelectedUnitSystem");this.getSelectedUnitSystem=e}initializeCommonElements(){this.form=this.getElement(E.common.form),this.resultsTable=this.getElement(E.common.resultTable),this.errorMessage=this.getElement(E.common.errorMessage)}initializeInputs(e){e.forEach(t=>this.initializedInputField(t))}initializedInputField(e){const t=this.getElement(E.inputs[e]);t&&this.inputs.set(e,t)}initializeSelectField(e){const t=this.getElement(E.selects[e]);t&&this.selects.set(e,t)}bindFormEvents(e){var i;(i=this.form)==null||i.addEventListener("submit",r=>{r.preventDefault();const l=new FormData(this.form);e(l)}),this.bindResetEvent();const t=this.selects.get("unitSystem");t&&t.addEventListener("change",()=>this.updatePlaceholders())}setSelectValue(e,t){const i=this.selects.get(e);i&&t&&(i.value=t)}setInputValue(e,t){const i=this.inputs.get(e);i&&t!==void 0&&(i.value=t.toString())}fillFormData(e){e.unitSystem&&this.setSelectValue("unitSystem",e.unitSystem),Object.entries(e).forEach(([t,i])=>{typeof i=="number"?this.setInputValue(t,i):typeof i=="string"&&t!=="unitSystem"&&this.setSelectValue(t,i)}),this.updatePlaceholders()}bindResetEvent(){var t;const e=(t=this.form)==null?void 0:t.querySelector('button[type="reset"]');e==null||e.addEventListener("click",i=>{i.preventDefault(),this.clearForm(),this.clearResults(),this.hideError(),this.updatePlaceholders()})}clearForm(){var e;(e=this.form)==null||e.reset()}clearResults(){if(this.resultsTable){const e=this.resultsTable.rows;for(let t=0;t<e.length;t++){const i=e[t].cells[1];i&&(i.textContent="-")}}}updatePlaceholders(){const e=this.getSelectedUnitSystem();this.inputs.forEach((t,i)=>{const r=k[e][i];r&&(t.placeholder=r)})}getElement(e){return document.querySelector(e)}createElement(e,t){const i=document.createElement(e);return t&&(i.className=t),i}showError(e){this.errorMessage&&(this.errorMessage.textContent=e,this.errorMessage.style.display="block")}hideError(){this.errorMessage&&(this.errorMessage.textContent="",this.errorMessage.style.display="none")}}var h=(a=>(a.METRIC="metric",a.IMPERIAL="imperial",a))(h||{});const _=`
      <section class="container">
    ...
    `;class x extends y{constructor(e){super(e)}render(e){e.innerHTML=_,this.initializeCommonElements(),this.initializeInputs(["weight","height"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.bmi,t[1].cells[1].textContent=e.category,t[2].cells[1].textContent=e.healthRisk,t[3].cells[1].textContent=e.idealWeight}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class N{constructor(e,t,i,r,l,o){this.user=e,this.bmiCalculator=t,this.bodycompositionCalculator=i,this.bmrCalculator=r,this.tdeeCalculator=l,this.calorieCalculator=o}getBmi(){return this.bmiCalculator.calculateBmi(this.user)}getBmiType(){const e=this.getBmi();return this.bmiCalculator.calculateBmiType(e)}getBmiPrime(){const e=this.getBmi();return this.bmiCalculator.calculateBmiPrime(e)}getIdealWeight(){return this.bmiCalculator.calculateIdealWeight(this.user)}getWaistToHipRatio(){return this.bodycompositionCalculator.calculateWaistToHipRatio(this.user)}getWaistToHeightRatio(){return this.bodycompositionCalculator.calculateWaistToHeightRatio(this.user)}getBodyFatPercentage(){return this.bodycompositionCalculator.calculateBodyFatPercentage(this.user)}getLeanBodyMass(){return this.bodycompositionCalculator.calculateLeanBodyMass(this.user)}getBmrHarrisBenedict(){return this.bmrCalculator.calculateBmrHarrisBenedict(this.user)}getBmrMifflinStJeor(){return this.bmrCalculator.calculateBmrMifflinStJeor(this.user)}getTdeeHarrisBenedict(){const e=this.getBmrHarrisBenedict();return this.tdeeCalculator.calculateTdeeHarrisBenedict(this.user,e)}getTdeeMifflinStJeor(){const e=this.getBmrMifflinStJeor();return this.tdeeCalculator.calculateTdeeMifflinStJeor(this.user,e)}getCaloricSurplusOrDeficit(){const e=this.getTdeeHarrisBenedict();return this.calorieCalculator.calculateCaloricSurplusOrDeficit(this.user,e)}getEstimatedWeightChangeWeekly(){const e=this.getCaloricSurplusOrDeficit();return this.calorieCalculator.calculateEstimatedWeightChangeWeekly(e,this.user)}getEstimatedWeightChangeMonthly(){const e=this.getCaloricSurplusOrDeficit();return this.calorieCalculator.calculateEstimatedWeightChangeMonthly(e,this.user)}getEstimateTimeToWeightGoal(){const e=this.getCaloricSurplusOrDeficit();return this.calorieCalculator.calculateEstimatedWeeksToWeightGoal(e,this.user)}getCaloriesForWeightGoal(){const e=this.getTdeeHarrisBenedict();return this.calorieCalculator.calculateCaloriesForWeightGoal(this.user,e)}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */var u;(function(a){a.UnderweightSevereThinness="underweight, severe thinness",a.UnderweightModerateThinness="underweight, moderate thinness",a.UnderweightMildThinness="underweight, mild thinness",a.Normal="normal weight",a.Overweight="overweight, pre-obese",a.ObeseFirstGrade="obese, class I",a.ObeseSecondGrade="obese, class II",a.ObeseThirdGrade="obese, class III"})(u||(u={}));const I=[{min:0,max:15.9,type:u.UnderweightSevereThinness},{min:16,max:16.9,type:u.UnderweightModerateThinness},{min:17,max:18.4,type:u.UnderweightMildThinness},{min:18.5,max:24.9,type:u.Normal},{min:25,max:29.9,type:u.Overweight},{min:30,max:34.9,type:u.ObeseFirstGrade},{min:35,max:39.9,type:u.ObeseSecondGrade},{min:40,max:100,type:u.ObeseThirdGrade}];var f;(function(a){a.Sedentary="sedentary",a.Lightly="lightly",a.Moderately="moderately",a.Very="very",a.Extremely="extremely"})(f||(f={}));/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class D{calculateBmi(e){this.validateWeightAndHeight(e);const t=2;return e.weight/Math.pow(e.height,t)}calculateBmiType(e){this.validateBmi(e);const t=this.roundBmi(e);return this.findBmiType(t)}calculateIdealWeight(e){this.validateHeight(e);const t=this.getNormalBmiRange(),i=this.calculateWeight(t.min,e.height),r=this.calculateWeight(t.max,e.height);return[i,r]}calculateBmiPrime(e){return e/25}validateWeightAndHeight(e){if(e.weight===void 0||e.height===void 0)throw new Error("Weight and height are required for BMI calculation.");if(typeof e.weight!="number"||typeof e.height!="number")throw new Error("Weight and height must be numbers.");if(e.weight<=0||e.height<=0)throw new Error("Weight and height must be positive numbers.")}validateHeight(e){if(e.height===void 0)throw new Error("Height is required for ideal weight calculation.");if(typeof e.height!="number")throw new Error("Height must be a number.");if(e.height<=0)throw new Error("Height must be a positive number.")}validateBmi(e){if(e<=0||e>100)throw new Error(`BMI out of range. Please check your values. BMI: ${e}`)}roundBmi(e){return Math.round(e)}findBmiType(e){for(const t of I)if(e>=t.min&&e<=t.max)return t.type;throw new Error("Bmi Type could not be found")}getNormalBmiRange(){const e=I.find(t=>t.type===u.Normal);if(!e)throw new Error("Could not find normal BMI range.");return e}calculateWeight(e,t){return e*Math.pow(t,2)}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class V{constructor(){this.CM_PER_METER=100,this.PERCENTAGE=100,this.TOTAL_BODY_COMPOSITION=1,this.BODY_FAT={CONSTANT_FACTOR:495,SUBTRACTION_CONSTANT:450},this.BODY_FAT_MALE={CONSTANT:1.0324,WAIST_NECK_FACTOR:.19077,HEIGHT_FACTOR:.15456},this.BODY_FAT_FEMALE={CONSTANT:1.29579,WAIST_HIP_NECK_FACTOR:.35004,HEIGHT_FACTOR:.221}}calculateWaistToHipRatio(e){return this.validateWaistAndHip(e),e.waist/e.hip}calculateWaistToHeightRatio(e){this.validateWaistAndHeight(e);const t=this.convertHeightToCentimeter(e.height);return e.waist/t}calculateBodyFatPercentage(e){this.validateRequiredMeasurements(e);const t=this.convertHeightToCentimeter(e.height);return this.calculateBodyFatBasedOnGender(e,t)}calculateLeanBodyMass(e){this.validateRequiredMeasurements(e);const i=this.calculateBodyFatPercentage(e)/this.PERCENTAGE,r=this.TOTAL_BODY_COMPOSITION-i;return e.weight*r}convertHeightToCentimeter(e){return e*this.CM_PER_METER}calculateMaleBodyFat(e,t){this.validateWaistAndNeck(e);const{CONSTANT:i,WAIST_NECK_FACTOR:r,HEIGHT_FACTOR:l}=this.BODY_FAT_MALE,{CONSTANT_FACTOR:o,SUBTRACTION_CONSTANT:d}=this.BODY_FAT,p=i-r*Math.log10(e.waist-e.neck)+l*Math.log10(t);return o/p-d}calculateFemaleBodyFat(e,t){this.validateWaistHipAndNeck(e);const{CONSTANT:i,WAIST_HIP_NECK_FACTOR:r,HEIGHT_FACTOR:l}=this.BODY_FAT_FEMALE,{CONSTANT_FACTOR:o,SUBTRACTION_CONSTANT:d}=this.BODY_FAT,p=i-r*Math.log10(e.waist+e.hip-e.neck)+l*Math.log10(t);return o/p-d}validateWaistAndHip(e){if(!e.waist||!e.hip)throw new Error("Waist and hip measurements are required for waist to hip calculation.")}validateWaistAndHeight(e){if(!e.waist||!e.height)throw new Error("Waist and height measurements are required for waist to height calculation.")}validateWaistHipAndNeck(e){if(!e.waist||!e.neck||!e.hip)throw new Error("Waist, hip and neck is required to calculate body fat percentage for female")}validateWaistAndNeck(e){if(!e.waist||!e.neck)throw new Error("Waist and neck is required to calculate body fat percentage for male")}validateRequiredMeasurements(e){if(e.weight===void 0||e.height===void 0)throw new Error("Weight and height are required for body composition calculations.")}calculateBodyFatBasedOnGender(e,t){if(e.gender==="male")return this.calculateMaleBodyFat(e,t);if(e.gender==="female")return this.calculateFemaleBodyFat(e,t);throw new Error('Invalid gender. Gender must be either "male" or "female".')}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class P{constructor(){this.CM_PER_METER=100,this.MIFFLIN_ST_JEOR={WEIGHT_FACTOR:10,HEIGHT_FACTOR:6.25,AGE_FACTOR:5,MALE_ADJUSTMENT:5,FEMALE_ADJUSTMENT:-161},this.HARRIS_BENEDICT={FEMALE:{BASE:447.593,WEIGHT_FACTOR:9.247,HEIGHT_FACTOR:3.098,AGE_FACTOR:4.33},MALE:{BASE:88.362,WEIGHT_FACTOR:13.397,HEIGHT_FACTOR:4.799,AGE_FACTOR:5.677}}}calculateBmrHarrisBenedict(e){this.validateRequiredFields(e);const t=this.convertHeightToCentimeter(e.height);return this.calculateBmrBasedOnGender(e,t)}calculateBmrMifflinStJeor(e){this.validateRequiredFields(e);const t=this.convertHeightToCentimeter(e.height),i=this.MIFFLIN_ST_JEOR.WEIGHT_FACTOR*e.weight,r=this.MIFFLIN_ST_JEOR.HEIGHT_FACTOR*t,l=this.MIFFLIN_ST_JEOR.AGE_FACTOR*e.age,o=e.gender==="male"?this.MIFFLIN_ST_JEOR.MALE_ADJUSTMENT:this.MIFFLIN_ST_JEOR.FEMALE_ADJUSTMENT;return i+r-l+o}convertHeightToCentimeter(e){return e*this.CM_PER_METER}harrisBenedictFemale(e,t){const{BASE:i,WEIGHT_FACTOR:r,HEIGHT_FACTOR:l,AGE_FACTOR:o}=this.HARRIS_BENEDICT.FEMALE,d=r*e.weight,p=l*t,T=o*e.age;return i+d+p-T}harrisBenedictMale(e,t){const{BASE:i,WEIGHT_FACTOR:r,HEIGHT_FACTOR:l,AGE_FACTOR:o}=this.HARRIS_BENEDICT.MALE,d=r*e.weight,p=l*t,T=o*e.age;return i+d+p-T}calculateBmrBasedOnGender(e,t){if(e.gender==="male")return this.harrisBenedictMale(e,t);if(e.gender==="female")return this.harrisBenedictFemale(e,t);throw new Error("Invalid gender. Gender must be either 'male' or 'female'.")}validateRequiredFields(e){if(e.weight===void 0||typeof e.weight!="number"||e.weight<=0)throw new Error("Valid weight is required for BMR calculation.");if(e.height===void 0||typeof e.height!="number"||e.height<=0)throw new Error("Valid height is required for BMR calculation.");if(e.age===void 0||typeof e.age!="number"||e.age<=0)throw new Error("Valid age is required for BMR calculation.");if(e.gender===void 0||e.gender!=="male"&&e.gender!=="female")throw new Error("Valid gender is required for BMR calculation. Gender must be either 'male' or 'female'.")}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class U{constructor(){this.ACTIVITY_FACTORS={SEDENTARY:1.2,LIGHTLY:1.375,MODERATELY:1.55,VERY:1.725,EXTREMELY:1.9}}calculateTdeeMifflinStJeor(e,t){this.validateAgeAndActivityLevel(e);const i=t,r=this.getActivityFactor(e.activityLevel);return this.calculateTdee(i,r)}calculateTdeeHarrisBenedict(e,t){this.validateAgeAndActivityLevel(e);const i=t,r=this.getActivityFactor(e.activityLevel);return this.calculateTdee(i,r)}getActivityFactor(e){switch(e){case f.Sedentary:return this.ACTIVITY_FACTORS.SEDENTARY;case f.Lightly:return this.ACTIVITY_FACTORS.LIGHTLY;case f.Moderately:return this.ACTIVITY_FACTORS.MODERATELY;case f.Very:return this.ACTIVITY_FACTORS.VERY;case f.Extremely:return this.ACTIVITY_FACTORS.EXTREMELY;default:throw new Error("Activity level must be sedentary, lightly, moderately, very, or extremely")}}validateAgeAndActivityLevel(e){if(!e.age||!e.activityLevel)throw new Error("Age and activity level is required")}calculateTdee(e,t){return e*t}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */const J={min:0,max:700},Y={min:0,max:1543},q={min:0,max:2.5},z={min:0,max:8.2};function j(a){try{K(a),a.weight!==void 0&&Q(a),a.height!==void 0&&Z(a),ee(a),te(a),ie(a),X(a),ae(a),se(a),re(a)}catch(e){const t=`Validation error in user object: ${JSON.stringify(a)} - ${e.message}. Stack trace: ${e.stack}`;throw new Error(t)}}function K(a){["age","waist","hip","neck","dailyCalories","weightGoal","weeksToWeightGoal"].forEach(t=>{if(t in a&&a[t]!==void 0&&typeof a[t]!="number")throw new TypeError(`${t} must be a number if provided`)})}function X(a){if(a.unitSystem===void 0)throw new Error("Unit system is required");if(typeof a.unitSystem!="string")throw new TypeError(`Unit system must be a string. Check the unitSystem value in ${JSON.stringify(a)}`);if(a.unitSystem!=="metric"&&a.unitSystem!=="imperial")throw new Error('Unit system must be either "metric" or "imperial"')}function F(a,e,t,i,r){if(a<e.min||a>e.max)throw new RangeError(`${t.charAt(0).toUpperCase()+t.slice(1)} using the ${i} system must be between ${e.min}-${e.max}. Check the ${t.toLowerCase()} value in ${JSON.stringify(r)}`)}function Q(a){if(typeof a.weight!="number")throw new Error(`Weight must be a number if provided. Check the weight value in ${JSON.stringify(a)}`);const e=a.unitSystem==="metric"?J:Y,t=a.unitSystem==="metric"?"metric":"imperial";F(a.weight,e,"weight",t,a)}function Z(a){if(typeof a.height!="number")throw new Error(`Height must be a number if provided. Check the height value in ${JSON.stringify(a)}`);const e=a.unitSystem==="metric"?q:z,t=a.unitSystem==="metric"?"metric":"imperial";F(a.height,e,"height",t,a)}function ee(a){if(a.gender!==void 0&&a.gender!=="male"&&a.gender!=="female")throw new TypeError(`Gender must be male or female. Check the gender value in ${JSON.stringify(a)}`)}function te(a){a.age!==void 0&&a.age<18&&console.warn(`Warning: health calculation might not be accurate for individuals under 18 years old. Check the age value in ${JSON.stringify(a)}`)}function ie(a){const e=["sedentary","lightly","moderately","very","extremely"];if(a.activityLevel!==void 0&&!e.includes(a.activityLevel))throw new TypeError(`Activity level must be sedentary, lightly, moderately, very or extremely. Check the activityLevel value in ${JSON.stringify(a)}`)}function ae(a){if(a.dailyCalories!==void 0&&a.dailyCalories<0)throw new Error(`Daily calories can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt - ${JSON.stringify(a)}`)}function se(a){if(a.weightGoal!==void 0&&a.weightGoal<0)throw new Error(`The weight goal can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt- ${JSON.stringify(a)}`)}function re(a){if(a.weeksToWeightGoal!==void 0&&a.weeksToWeightGoal<0)throw new Error(`Weeks to reach weight goal must be equal or greater than 0. User objekt- ${JSON.stringify(a)}`)}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */function le(a){return{...a}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */function ne(a){return a.unitSystem==="metric"?a:{...a,height:a.height!==void 0?oe(a.height):void 0,weight:a.weight!==void 0?M(a.weight):void 0,waist:a.waist!==void 0?b(a.waist):void 0,hip:a.hip!==void 0?b(a.hip):void 0,neck:a.neck!==void 0?b(a.neck):void 0,weightGoal:a.weightGoal!==void 0?M(a.weightGoal):void 0,unitSystem:"metric"}}function oe(a){return a!==void 0?a*.3048:void 0}function M(a){return a!==void 0?a*.453592:void 0}function b(a){return a!==void 0?a*2.54:void 0}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class he{constructor(){this.DAYS_IN_WEEK=7,this.DAYS_IN_MONTH=30,this.CALORIES_PER_KILO=7700,this.REFERENCE_WEIGHT=70}calculateCaloricSurplusOrDeficit(e,t){return this.validateDailyCalories(e),t-e.dailyCalories}calculateEstimatedWeightChangeWeekly(e,t){return this.validateWeight(t),this.estimateWeightChange(e,t,this.DAYS_IN_WEEK)}calculateEstimatedWeightChangeMonthly(e,t){return this.validateWeight(t),this.estimateWeightChange(e,t,this.DAYS_IN_MONTH)}calculateEstimatedWeeksToWeightGoal(e,t){this.validateWeightGoal(t),this.validateWeight(t);const i=this.estimateWeightChange(e,t,this.DAYS_IN_WEEK),r=t.weightGoal-t.weight,o=Math.abs(r)/Math.abs(i);return Math.ceil(o)}calculateCaloriesForWeightGoal(e,t){this.validateWeightGoal(e),this.validateWeight(e),this.validateWeeksToWeightGoal(e);const i=e.weightGoal-e.weight,o=Math.abs(i)/e.weeksToWeightGoal*this.CALORIES_PER_KILO/this.DAYS_IN_WEEK;return i>0?Math.round(t+o):Math.round(t-o)}validateDailyCalories(e){if(e.dailyCalories===void 0||typeof e.dailyCalories!="number"||e.dailyCalories<0)throw new Error("Valid dailyCalories is required for calorie calculation")}validateWeightGoal(e){if(e.weightGoal===void 0||typeof e.weightGoal!="number"||e.weightGoal<=0)throw new Error("Valid weightGoal is required for some calorie calculations")}validateWeight(e){if(e.weight===void 0||typeof e.weight!="number"||e.weight<=0)throw new Error("Valid weight is required for some calorie calculations")}validateWeeksToWeightGoal(e){if(e.weeksToWeightGoal===void 0||typeof e.weeksToWeightGoal!="number"||e.weeksToWeightGoal<=0)throw new Error("Valid weeksToWeightGoal is required for some calorie calculations")}estimateWeightChange(e,t,i){const r=this.CALORIES_PER_KILO*(t.weight/this.REFERENCE_WEIGHT);return e*i/r}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */class ce{static createHealthCalculator(e){j(e);const t=le(e),i=ne(t),r=new D,l=new V,o=new P,d=new U,p=new he;return new N(i,r,l,o,d,p)}}var g=(a=>(a.UNDERWEIGHT_SEVERE="underweight, severe thinness",a.UNDERWEIGHT_MODERATE="underweight, moderate thinness",a.UNDERWEIGHT_MILD="underweight, mild thinness",a.NORMAL_WEIGHT="normal weight",a.OVERWEIGHT_PRE_OBESE="overweight, pre-obese",a.OBESE_CLASS_I="obese, class I",a.OBESE_CLASS_II="obese, class II",a.OBESE_CLASS_III="obese, class III",a))(g||{});class de{static fromString(e){const t=e.toLowerCase().trim();for(const[i,r]of Object.entries(g))if(r.toLowerCase()===t)return g[i];throw new Error(`Invalid BMI category: ${e}`)}}function ue(a){switch(a){case g.UNDERWEIGHT_SEVERE:return"High risk of malnutrition, weakened immune system, and more.";case g.UNDERWEIGHT_MODERATE:return"Risks include nutrient deficiencies and weakened immune response.";case g.UNDERWEIGHT_MILD:return"Moderate risk of malnutrition.";case g.NORMAL_WEIGHT:return"Lowest health risks with a balanced lifestyle.";case g.OVERWEIGHT_PRE_OBESE:return"Increased risk of cardiovascular diseases and type 2 diabetes.";case g.OBESE_CLASS_I:return"Significant risk of metabolic syndrome and heart disease.";case g.OBESE_CLASS_II:return"Increased risk for heart disease and stroke.";case g.OBESE_CLASS_III:return"Severe health risks including reduced life expectancy.";default:return"Unknown health risk."}}class ge{constructor(e){n(this,"calculator");this.userModel=e,this.calculator=this.createCalculator()}createCalculator(){const e=this.userModel.getData();return ce.createHealthCalculator({unitSystem:e.unitSystem,weight:e.weight??70,height:e.height??1.75,age:e.age,gender:e.gender,waist:e.waist,hip:e.hip,neck:e.neck,activityLevel:e.activityLevel,dailyCalories:e.dailyCalories,weightGoal:e.weightGoal,weeksToWeightGoal:e.weeksToWeightGoal})}getBmi(){return this.calculator=this.createCalculator(),this.calculator.getBmi()}getBmiType(){this.calculator=this.createCalculator();const e=this.calculator.getBmiType();return de.fromString(e)}getHealthRisk(){return ue(this.getBmiType())}getBmiPrime(){return this.calculator=this.createCalculator(),this.calculator.getBmiPrime()}getIdealWeight(){return this.calculator=this.createCalculator(),this.calculator.getIdealWeight()}getBodyFatPercentage(){return this.calculator=this.createCalculator(),this.calculator.getBodyFatPercentage()}getWaistToHipRatio(){return this.calculator=this.createCalculator(),this.calculator.getWaistToHipRatio()}getWaistToHeightRatio(){return this.calculator=this.createCalculator(),this.calculator.getWaistToHeightRatio()}getLeanBodyMass(){return this.calculator=this.createCalculator(),this.calculator.getLeanBodyMass()}getBmrMifflinStJeor(){return this.calculator=this.createCalculator(),this.calculator.getBmrMifflinStJeor()}getBmrHarrisBenedict(){return this.calculator=this.createCalculator(),this.calculator.getBmrHarrisBenedict()}getTdeeMifflinStJeor(){return this.calculator=this.createCalculator(),this.calculator.getTdeeMifflinStJeor()}getTdeeHarrisBenedict(){return this.calculator=this.createCalculator(),this.calculator.getTdeeHarrisBenedict()}getCaloricSurplusOrDeficit(){return this.calculator=this.createCalculator(),this.calculator.getCaloricSurplusOrDeficit()}getEstimatedWeightChangeWeekly(){return this.calculator=this.createCalculator(),this.calculator.getEstimatedWeightChangeWeekly()}getEstimatedWeightChangeMonthly(){return this.calculator=this.createCalculator(),this.calculator.getEstimatedWeightChangeMonthly()}getEstimateTimeToWeightGoal(){return this.calculator=this.createCalculator(),this.calculator.getEstimateTimeToWeightGoal()}getCaloriesForWeightGoal(){return this.calculator=this.createCalculator(),this.calculator.getCaloriesForWeightGoal()}}class me{constructor(e){n(this,"calculator");this.calculator=new ge(e)}getBmi(){return this.calculator.getBmi()}getBmiType(){return this.calculator.getBmiType()}getHealthRisk(){return this.calculator.getHealthRisk()}getBmiPrime(){return this.calculator.getBmiPrime()}getIdealWeight(){return this.calculator.getIdealWeight()}getBodyFatPercentage(){return this.calculator.getBodyFatPercentage()}getWaistToHipRatio(){return this.calculator.getWaistToHipRatio()}getWaistToHeightRatio(){return this.calculator.getWaistToHeightRatio()}getLeanBodyMass(){return this.calculator.getLeanBodyMass()}getBmrMifflinStJeor(){return this.calculator.getBmrMifflinStJeor()}getBmrHarrisBenedict(){return this.calculator.getBmrHarrisBenedict()}getTdeeMifflinStJeor(){return this.calculator.getTdeeMifflinStJeor()}getTdeeHarrisBenedict(){return this.calculator.getTdeeHarrisBenedict()}getCaloricSurplusOrDeficit(){return this.calculator.getCaloricSurplusOrDeficit()}getEstimatedWeightChangeWeekly(){return this.calculator.getEstimatedWeightChangeWeekly()}getEstimatedWeightChangeMonthly(){return this.calculator.getEstimatedWeightChangeMonthly()}getCaloriesForWeightGoal(){return this.calculator.getCaloriesForWeightGoal()}getEstimateTimeToWeightGoal(){return this.calculator.getEstimateTimeToWeightGoal()}}class v{constructor(e,t){n(this,"user");n(this,"calculator");this.user=e,this.calculator=t}bindFormEvents(e){this.view.bindFormEvents(e)}handleErrors(e){this.view.showError(e.message)}resetForm(){this.user.resetData(),this.view.clearForm(),this.view.hideError()}fillFormData(e){e.unitSystem&&this.view.setSelectValue("unitSystem",e.unitSystem),Object.entries(e).forEach(([t,i])=>{typeof i=="number"?this.view.setInputValue(t,i):typeof i=="string"&&this.view.setSelectValue(t,i)}),this.updatePlaceholders()}updatePlaceholders(){this.view.updatePlaceholders()}handleFormSubmit(e){e.preventDefault();const t=new FormData(e.target);this.handleCalculate(t)}handleReset(){this.user.resetData(),this.view.clearForm(),this.view.clearResults(),this.view.hideError(),this.updatePlaceholders()}}var m=(a=>(a.MALE="male",a.FEMALE="female",a))(m||{}),c=(a=>(a.SEDENTARY="sedentary",a.LIGHTLY="lightly",a.MODERATELY="moderately",a.VERY="very",a.EXTREMELY="extremely",a))(c||{});class w{constructor(){n(this,"CONVERSION_FACTORS",{POUNDS:2.20462,FEET:3.28084,INCHES:1/2.54});n(this,"UNITS",{METRIC:{WEIGHT:"kg",HEIGHT:"m",MEASUREMENT:"cm"},IMPERIAL:{WEIGHT:"lbs",HEIGHT:"ft",MEASUREMENT:"inches"}});n(this,"LIMITS",{weight:{min:20,max:500},height:{min:.5,max:2.5},age:{min:18,max:120},waist:{min:40,max:200},hip:{min:50,max:200},neck:{min:20,max:80},calories:{min:500,max:1e4},weeksToWeightGoal:{min:1,max:520}})}validateWeight(e,t){this.validateNumericInput(e,"Weight");const i=t===h.IMPERIAL,{min:r,max:l}=this.getConvertedLimits({min:this.LIMITS.weight.min,max:this.LIMITS.weight.max,shouldConvert:i,conversionFactor:this.CONVERSION_FACTORS.POUNDS});this.validateRange({value:e,min:r,max:l,name:"Weight",unit:i?this.UNITS.IMPERIAL.WEIGHT:this.UNITS.METRIC.WEIGHT})}validateHeight(e,t){this.validateNumericInput(e,"Height");const i=t===h.IMPERIAL,{min:r,max:l}=this.getConvertedLimits({min:this.LIMITS.height.min,max:this.LIMITS.height.max,shouldConvert:i,conversionFactor:this.CONVERSION_FACTORS.FEET});this.validateRange({value:e,min:r,max:l,name:"Height",unit:i?this.UNITS.IMPERIAL.HEIGHT:this.UNITS.METRIC.HEIGHT})}validateBodyMeasurement(e,t,i){this.validateNumericInput(e,t);const r=i===h.IMPERIAL,{min:l,max:o}=this.getConvertedLimits({min:this.LIMITS[t].min,max:this.LIMITS[t].max,shouldConvert:r,conversionFactor:this.CONVERSION_FACTORS.INCHES});this.validateRange({value:e,min:l,max:o,name:t.charAt(0).toUpperCase()+t.slice(1),unit:r?this.UNITS.IMPERIAL.MEASUREMENT:this.UNITS.METRIC.MEASUREMENT})}validateAge(e){this.validateNumericInput(e,"Age");const t=this.LIMITS.age;if(e<t.min||e>t.max)throw new Error(`Age must be between ${t.min} and ${t.max} years`)}validateWeightGoal(e,t){this.validateNumericInput(e,"Weight goal");const i=t===h.IMPERIAL,{min:r,max:l}=this.getConvertedLimits({min:this.LIMITS.weight.min,max:this.LIMITS.weight.max,shouldConvert:i,conversionFactor:this.CONVERSION_FACTORS.POUNDS});this.validateRange({value:e,min:r,max:l,name:"Weight goal",unit:i?this.UNITS.IMPERIAL.WEIGHT:this.UNITS.METRIC.WEIGHT})}validateWeeksToWeightGoal(e){this.validateNumericInput(e,"Weeks to weight goal"),this.validateRange({value:e,min:this.LIMITS.weeksToWeightGoal.min,max:this.LIMITS.weeksToWeightGoal.max,name:"Weeks to goal",unit:"weeks"})}validateDailyCalories(e){this.validateNumericInput(e,"Daily calories"),this.validateRange({value:e,min:this.LIMITS.calories.min,max:this.LIMITS.calories.max,name:"Daily calories",unit:"calories"})}getConvertedLimits(e){const{min:t,max:i,shouldConvert:r,conversionFactor:l}=e;return r?{min:Math.round(t*l),max:Math.round(i*l)}:{min:t,max:i}}validateRange(e){const{value:t,min:i,max:r,name:l,unit:o}=e;if(t<i||t>r)throw new Error(`${l} must be between ${i} and ${r} ${o}`)}validateBmiFormData(e){this.validateUnitSystem(e.unitSystem),this.validateWeight(e.weight,e.unitSystem),this.validateHeight(e.height,e.unitSystem)}validateTotalDailyEnergyExpenditureFormData(e){this.validateUnitSystem(e.unitSystem),this.validateGender(e.gender),this.validateWeight(e.weight,e.unitSystem),this.validateHeight(e.height,e.unitSystem),this.validateAge(e.age),this.validateActivityLevel(e.activityLevel)}validateWaistToHipRatioFormData(e){this.validateUnitSystem(e.unitSystem),this.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.validateBodyMeasurement(e.hip,"hip",e.unitSystem)}validateWaistHeightRatioFormData(e){this.validateUnitSystem(e.unitSystem),this.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.validateHeight(e.height,e.unitSystem)}validateBodyFatPercentageFormData(e){this.validateUnitSystem(e.unitSystem),this.validateGender(e.gender),this.validateWeight(e.weight,e.unitSystem),this.validateBodyMeasurement(e.waist,"waist",e.unitSystem),this.validateBodyMeasurement(e.neck,"neck",e.unitSystem),e.gender===m.FEMALE&&e.hip!==void 0&&this.validateBodyMeasurement(e.hip,"hip",e.unitSystem)}validateBasalMetabolicRateFormData(e){this.validateUnitSystem(e.unitSystem),this.validateGender(e.gender),this.validateWeight(e.weight,e.unitSystem),this.validateHeight(e.height,e.unitSystem),this.validateAge(e.age)}validateCaloriesForWeightGoalFormData(e){this.validateUnitSystem(e.unitSystem),this.validateGender(e.gender),this.validateWeight(e.weight,e.unitSystem),this.validateHeight(e.height,e.unitSystem),this.validateAge(e.age),this.validateActivityLevel(e.activityLevel),this.validateWeightGoal(e.weightGoal,e.unitSystem),this.validateWeeksToWeightGoal(e.weeksToWeightGoal)}validateEstimateTimeToWeightGoalFormData(e){this.validateUnitSystem(e.unitSystem),this.validateGender(e.gender),this.validateActivityLevel(e.activityLevel),this.validateWeight(e.weight,e.unitSystem),this.validateHeight(e.height,e.unitSystem),this.validateAge(e.age),this.validateWeightGoal(e.weightGoal,e.unitSystem),this.validateDailyCalories(e.dailyCalories)}validateUnitSystem(e){if(!Object.values(h).includes(e))throw new Error("Invalid unit system value")}validateGender(e){if(!Object.values(m).includes(e))throw new Error("Invalid gender value")}validateActivityLevel(e){if(!Object.values(c).includes(e))throw new Error("Invalid activity level value")}validateNumericInput(e,t){if(typeof e!="number"||isNaN(e)||e<=0)throw new Error(`Invalid ${t} value`)}}class pe extends v{constructor(t,i){super(t,i);n(this,"view");n(this,"formValidator");this.view=new x(this.getUnitSystemValue.bind(this)),this.formValidator=new w}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??h.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateBmiFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}getUniSystemValue(){return this.user.getData().unitSystem??h.METRIC}parseFormData(t){return{unitSystem:t.get("unitSystem"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height"))}}updateView(){const t=this.calculator.getBmi(),i=this.calculator.getBmiType(),r=this.calculator.getHealthRisk(),l=this.calculator.getIdealWeight(),o={bmi:this.formatValue(t),category:i,healthRisk:r,idealWeight:this.formatIdealWeight(l)};this.view.updateResults(o)}formatValue(t){return t.toFixed(1)}formatIdealWeight([t,i]){return`${this.formatValue(t)} - ${this.formatValue(i)} kg`}}const ye=`
<section class="container">
    <h2>"${s.waist}"-to-"${s.hip}" Ratio Calculator</h2>
    <div class="content">
        <p class="description">
            Calculate your "${s.waist}"-to-"${s.hip}" 
    ...
    <div class="sources">
        ...
        <ul>
            ...
            "${s.waist}"-to-"${s.hip}" Ratio</li>
            <li>Centers for Disease Control and Prevention (CDC) – 
            Health Guidelines</li>
        </ul>
    </div>
</section>
`;class ve extends y{constructor(e){super(e)}render(e){e.innerHTML=ye,this.initializeCommonElements(),this.initializeInputs(["hip","waist"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.waistToHipRatio}}class we extends v{constructor(t,i){super(t,i);n(this,"view");n(this,"formValidator");this.view=new ve(this.getUnitSystemValue.bind(this)),this.formValidator=new w}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??h.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateWaistToHipRatioFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),hip:parseFloat(t.get("hip"))}}updateView(){const t=this.calculator.getWaistToHipRatio(),i={waistToHipRatio:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return t.toFixed(2)}}const fe=`
<section class="container">
    <h2>"${s.waist}"-to-Height Ratio Calculator</h2>
    <div class="content">
        <p class="description">
    ...
    <div class="sources">
        ...
        <ul>
            ...
            "${s.waist}"-to-Height Ratio Research</li>
            <li>American Heart Association – Cardiovascular Health</li>
        </ul>
    </div>
</section>
`;class Ee extends y{constructor(e){super(e)}render(e){e.innerHTML=fe,this.initializeCommonElements(),this.initializeInputs(["waist","height"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.waistToHeightRatio}}class Te extends v{constructor(t,i){super(t,i);n(this,"view");n(this,"formValidator");this.view=new Ee(this.getUnitSystemValue.bind(this)),this.formValidator=new w}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??h.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateWaistHeightRatioFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),height:parseFloat(t.get("height"))}}updateView(){const t=this.calculator.getWaistToHeightRatio(),i={waistToHeightRatio:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return t.toFixed(2)}}const be=`
<section class="container">
...
`;class Ce extends y{constructor(t){super(t);n(this,"hipInputGroup",null)}render(t){t.innerHTML=be,this.initializeCommonElements(),this.initializeInputs(["weight","waist","hip","neck"]),this.initializeSelectField("unitSystem"),this.hipInputGroup=this.getHipInputGroup()}bindGenderChange(t){document.querySelectorAll('input[name="gender"]').forEach(r=>{r.addEventListener("change",l=>{const o=l.target;t(o.value)})})}setGenderSelection(t){const i=document.querySelector(`input[value="${t}"]`);i&&(i.checked=!0)}toggleHipInputVisibility(t){this.hipInputGroup&&(this.hipInputGroup.style.display=t?"block":"none")}clearHipInput(){const t=this.inputs.get("hip");t&&(t.value="")}getHipInputGroup(){const t=this.inputs.get("hip");return(t==null?void 0:t.closest(".input-group"))||null}updateResults(t){if(!this.resultsTable)return;const i=this.resultsTable.rows;i[0].cells[1].textContent=t.bodyFatPercentage,i[1].cells[1].textContent=t.leanBodyMass}}class Se extends v{constructor(t,i){super(t,i);n(this,"view");n(this,"formValidator");this.view=new Ce(this.getUnitSystemValue.bind(this)),this.formValidator=new w}init(t){this.view.render(t),this.view.bindGenderChange(this.handleGenderChange.bind(this));const i=this.user.getData();this.fillFormData(i),i.gender?this.handleGenderChange(i.gender):this.view.toggleHipInputVisibility(!1),this.bindFormEvents(this.handleCalculate.bind(this))}handleGenderChange(t){const i=t===m.FEMALE;this.view.toggleHipInputVisibility(i),i||this.view.clearHipInput()}getUnitSystemValue(){return this.user.getData().unitSystem??h.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateBodyFatPercentageFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){const i={unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),waist:parseFloat(t.get("waist")),neck:parseFloat(t.get("neck"))};if(i.gender===m.FEMALE){const r=t.get("hip");if(r)i.hip=parseFloat(r);else throw new Error("Hip measurement is required for females.")}return i}updateView(){const t=this.calculator.getBodyFatPercentage(),i=this.calculator.getLeanBodyMass(),r={bodyFatPercentage:this.formatBodyFatPercentage(t),leanBodyMass:this.formatLeanBodyMass(i)};this.view.updateResults(r)}formatBodyFatPercentage(t){return`${t.toFixed(2)} %`}formatLeanBodyMass(t){return`${t.toFixed(2)} kg`}}const Ie=`
  <section class="container">
...
`;class Me extends y{constructor(e){super(e)}render(e){e.innerHTML=Ie,this.initializeCommonElements(),this.initializeInputs(["weight","height","age"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.totalDailyEnergyExpenditureHarris,t[1].cells[1].textContent=e.totalDailyEnergyExpenditureMifflin}}class Re extends v{constructor(t,i){super(t,i);n(this,"view");n(this,"formValidator");this.view=new Me(this.getUnitSystemValue.bind(this)),this.formValidator=new w}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??h.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateTotalDailyEnergyExpenditureFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age")),activityLevel:t.get("activityLevel")}}updateView(){const t=this.calculator.getTdeeHarrisBenedict(),i=this.calculator.getTdeeMifflinStJeor(),r={totalDailyEnergyExpenditureHarris:this.formatValue(t),totalDailyEnergyExpenditureMifflin:this.formatValue(i)};this.view.updateResults(r)}formatValue(t){return`${t.toFixed(0)} kcal/day`}}const Fe=`
  <section class="container">
...
`;class He extends y{constructor(e){super(e)}render(e){e.innerHTML=Fe,this.initializeCommonElements(),this.initializeInputs(["weight","height","age"]),this.initializeSelectFields(["unitSystem","gender"])}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.basalMetabolicRateHarrisBenedict,t[1].cells[1].textContent=e.basalMetabolicRateMifflinStJeor}initializeSelectFields(e){e.forEach(t=>this.initializeSelectField(t))}}class Ae extends v{constructor(t,i){super(t,i);n(this,"view");n(this,"formValidator");this.view=new He(this.getUnitSystemValue.bind(this)),this.formValidator=new w}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??h.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateBasalMetabolicRateFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){const i={unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age"))};if(!Object.values(m).includes(i.gender))throw new Error("Invalid gender value");return i}updateView(){const t=this.calculator.getBmrHarrisBenedict(),i=this.calculator.getBmrMifflinStJeor(),r={basalMetabolicRateHarrisBenedict:this.formatValue(t),basalMetabolicRateMifflinStJeor:this.formatValue(i)};this.view.updateResults(r)}formatValue(t){return`${t.toFixed(0)} kcal/day`}}const We=`
  <section class="container">
      ...
      <form id="time-to-goal-form">
        ...
        <div class="input-group">
          ...
          name="${s.gender}">
            ...
            <option value=${m.FEMALE}>Female</option>
          </select>
        </div>
        <div class="input-group">
          <label for="${s.height}">Height</label>
  ...
  <section class="container">
    ...
    <div class="content">
      ...
      <form id="calories-goal-form">
        ...
        <div class="input-group">
          <label for="${s.weeksToWeightGoal}">Weeks to Reach Goal</label>
...
`;class Ge extends y{constructor(e){super(e)}render(e){e.innerHTML=Le,this.initializeCommonElements(),this.initializeInputs(["weight","height","age","weightGoal","weeksToWeightGoal"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.dailyCalories}}class Oe extends v{constructor(t,i){super(t,i);n(this,"view");n(this,"formValidator");this.view=new Ge(this.getUnitSystemValue.bind(this)),this.formValidator=new w}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??h.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateTotalDailyEnergyExpenditureFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age")),activityLevel:t.get("activityLevel"),weightGoal:parseFloat(t.get("weightGoal")),weeksToWeightGoal:parseFloat(t.get("weeksToWeightGoal"))}}updateView(){const t=this.calculator.getCaloriesForWeightGoal(),i={dailyCalories:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return`${t.toFixed(0)} kcal/day`}}class ke{constructor(e,t){this.user=e,this.calculator=t}createController(e){switch(e){case"HOME":return this.createHomeController();case"BMI":return this.createBmiController();case"WAIST_TO_HIP":return this.createWaistToHipController();case"WAIST_TO_HEIGHT":return this.createWaistToHeightController();case"BODY_FAT":return this.createBodyFatController();case"BMR":return this.createBmrController();case"TDEE":return this.createTdeeController();case"WEIGHT_GOAL":return this.createWeightGoalController();case"CALORIE_GOAL":return this.createCalorieGoalController();default:throw new Error(`No controller found for route: ${e}`)}}createHomeController(){return new O}createBmiController(){return new pe(this.user,this.calculator)}createWaistToHipController(){return new we(this.user,this.calculator)}createWaistToHeightController(){return new Te(this.user,this.calculator)}createBodyFatController(){return new Se(this.user,this.calculator)}createBmrController(){return new Ae(this.user,this.calculator)}createTdeeController(){return new Re(this.user,this.calculator)}createWeightGoalController(){return new $e(this.user,this.calculator)}createCalorieGoalController(){return new Oe(this.user,this.calculator)}}class _e{constructor(e,t){n(this,"currentController",null);n(this,"controllerFactory");this.controllerFactory=new ke(e,t)}listen(){window.addEventListener("hashchange",()=>{const t=window.location.hash.slice(1);this.navigate(t)});const e=window.location.hash.slice(1)||"/";this.navigate(e)}navigate(e){const t=document.getElementById("app");if(!t)return;t.innerHTML="";const i=$(e);if(i!==void 0)try{this.currentController=this.controllerFactory.createController(i),this.currentController.init(t)}catch(r){console.error("Error creating controller:",r),t.innerHTML="<h2>An error occurred</h2>"}else t.innerHTML="<h2>404 Not Found</h2>"}}let C=null;class S{constructor(){n(this,"data");const e=sessionStorage.getItem("userModel");this.data=e?JSON.parse(e):{unitSystem:"metric"}}static getInstance(){return C||(C=new S),C}setData(e){Object.assign(this.data,e),this.saveToSession()}getData(){return{weight:this.data.weight,height:this.data.height,unitSystem:this.data.unitSystem,age:this.data.age,gender:this.data.gender,waist:this.data.waist,hip:this.data.hip,neck:this.data.neck,activityLevel:this.data.activityLevel,dailyCalories:this.data.dailyCalories,weightGoal:this.data.weightGoal,weeksToWeightGoal:this.data.weeksToWeightGoal}}resetData(){this.data={unitSystem:h.METRIC},this.saveToSession()}saveToSession(){sessionStorage.setItem("userModel",JSON.stringify(this.data))}}class xe{constructor(){n(this,"dropdownToggles");n(this,"dropdownMenus");this.dropdownToggles=Array.from(document.querySelectorAll(".dropdown-toggle")),this.dropdownMenus=Array.from(document.querySelectorAll(".dropdown-menu")),this.initializeDropdowns()}initializeDropdowns(){this.dropdownToggles.forEach(e=>{e.addEventListener("click",this.toggleDropdown.bind(this))}),document.addEventListener("click",this.handleOutsideClick.bind(this))}toggleDropdown(e){var r;e.preventDefault(),this.dropdownMenus.forEach(l=>{var o;(o=l.parentElement)==null||o.classList.remove("show")});const t=e.currentTarget,i=t.nextElementSibling;i&&i.classList.contains("dropdown-menu")&&((r=t.parentElement)==null||r.classList.toggle("show"))}handleOutsideClick(e){const t=e.target;this.dropdownToggles.some(r=>r.contains(t))||this.dropdownMenus.forEach(r=>{var l;(l=r.parentElement)==null||l.classList.remove("show")})}}class Ne{constructor(){n(this,"router");n(this,"user");n(this,"calculator");this.user=S.getInstance(),this.calculator=new me(this.user),this.router=new _e(this.user,this.calculator),new xe}start(){this.router.listen();const e=window.location.hash.slice(1)||"/";this.router.navigate(e)}}const De=new Ne;De.start();

var A=Object.defineProperty;var M=(i,t,e)=>t in i?A(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var o=(i,t,e)=>(M(i,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function e(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(r){if(r.ep)return;r.ep=!0;const s=e(r);fetch(r.href,s)}})();var w=(i=>(i[i.HOME=0]="HOME",i[i.BMI=1]="BMI",i[i.BMR=2]="BMR",i[i.TDEE=3]="TDEE",i[i.BODY_COMPOSITION=4]="BODY_COMPOSITION",i[i.CALORIE_CALCULATION=5]="CALORIE_CALCULATION",i[i.WAIST_TO_HIP=6]="WAIST_TO_HIP",i[i.WAIST_TO_HEIGHT=7]="WAIST_TO_HEIGHT",i[i.BODY_FAT_PERCENTAGE=8]="BODY_FAT_PERCENTAGE",i[i.LEAN_BODY_MASS=9]="LEAN_BODY_MASS",i))(w||{});const W={0:"/",1:"/bmi",2:"/bmr",3:"/tdee",4:"/body-composition",5:"/calorie-calculation",6:"/waist-to-hip",7:"/waist-to-height",8:"/body-fat-percentage",9:"/lean-body-mass"};function O(i){const t=Object.entries(W).find(([e,a])=>a===i);return t?Number(t[0]):void 0}var u=(i=>(i.BMI="bmi",i.BMR="bmr",i.TDEE="tdee",i.BODY_COMPOSITION="body-composition",i.CALORIE_CALCULATION="calorie-calculation",i))(u||{});class H{render(t){t.innerHTML=`
 ...
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */const P={min:0,max:700},x={min:0,max:1543},U={min:0,max:2.5},V={min:0,max:8.2};function J(i){try{Y(i),i.weight!==void 0&&$(i),i.height!==void 0&&K(i),j(i),z(i),X(i),q(i),Q(i),Z(i),tt(i)}catch(t){const e=`Validation error in user object: ${JSON.stringify(i)} - ${t.message}. Stack trace: ${t.stack}`;throw new Error(e)}}function Y(i){["age","waist","hip","neck","dailyCalories","weightGoal","weeksToWeightGoal"].forEach(e=>{if(e in i&&i[e]!==void 0&&typeof i[e]!="number")throw new TypeError(`${e} must be a number if provided`)})}function q(i){if(i.unitSystem===void 0)throw new Error("Unit system is required");if(typeof i.unitSystem!="string")throw new TypeError(`Unit system must be a string. Check the unitSystem value in ${JSON.stringify(i)}`);if(i.unitSystem!=="metric"&&i.unitSystem!=="imperial")throw new Error('Unit system must be either "metric" or "imperial"')}function R(i,t,e,a,r){if(i<t.min||i>t.max)throw new RangeError(`${e.charAt(0).toUpperCase()+e.slice(1)} using the ${a} system must be between ${t.min}-${t.max}. Check the ${e.toLowerCase()} value in ${JSON.stringify(r)}`)}function $(i){if(typeof i.weight!="number")throw new Error(`Weight must be a number if provided. Check the weight value in ${JSON.stringify(i)}`);const t=i.unitSystem==="metric"?P:x,e=i.unitSystem==="metric"?"metric":"imperial";R(i.weight,t,"weight",e,i)}function K(i){if(typeof i.height!="number")throw new Error(`Height must be a number if provided. Check the height value in ${JSON.stringify(i)}`);const t=i.unitSystem==="metric"?U:V,e=i.unitSystem==="metric"?"metric":"imperial";R(i.height,t,"height",e,i)}function j(i){if(i.gender!==void 0&&i.gender!=="male"&&i.gender!=="female")throw new TypeError(`Gender must be male or female. Check the gender value in ${JSON.stringify(i)}`)}function z(i){i.age!==void 0&&i.age<18&&console.warn(`Warning: health calculation might not be accurate for individuals under 18 years old. Check the age value in ${JSON.stringify(i)}`)}function X(i){const t=["sedentary","lightly","moderately","very","extremely"];if(i.activityLevel!==void 0&&!t.includes(i.activityLevel))throw new TypeError(`Activity level must be sedentary, lightly, moderately, very or extremely. Check the activityLevel value in ${JSON.stringify(i)}`)}function Q(i){if(i.dailyCalories!==void 0&&i.dailyCalories<0)throw new Error(`Daily calories can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt - ${JSON.stringify(i)}`)}function Z(i){if(i.weightGoal!==void 0&&i.weightGoal<0)throw new Error(`The weight goal can't be 0, leave the field empty if you don't want to use calorie calculation. User objekt- ${JSON.stringify(i)}`)}function tt(i){if(i.weeksToWeightGoal!==void 0&&i.weeksToWeightGoal<0)throw new Error(`Weeks to reach weight goal must be equal or greater than 0. User objekt- ${JSON.stringify(i)}`)}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */function et(i){return{...i}}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
 */function it(i){return i.unitSystem==="metric"?i:{...i,height:i.height!==void 0?at(i.height):void 0,weight:i.weight!==void 0?S(i.weight):void 0,waist:i.waist!==void 0?p(i.waist):void 0,hip:i.hip!==void 0?p(i.hip):void 0,neck:i.neck!==void 0?p(i.neck):void 0,weightGoal:i.weightGoal!==void 0?S(i.weightGoal):void 0,unitSystem:"metric"}}function at(i){return i!==void 0?i*.3048:void 0}function S(i){return i!==void 0?i*.453592:void 0}function p(i){return i!==void 0?i*2.54:void 0}/**
 * @license
 * Copyright (c) [2024] [Angelica Marker]. ISC License. See LICENSE for details.
...
`;class ut extends T{constructor(){super(...arguments);o(this,"form",null);o(this,"resultsTable",null);o(this,"waistInput",null);o(this,"hipInput",null);o(this,"unitSystemSelect",null)}render(e){var a;e.innerHTML=dt,this.form=this.getElement("#waist-hip-ratio-form"),this.resultsTable=this.getElement(".results table"),this.waistInput=this.getElement("#waist"),this.hipInput=this.getElement("#hip"),this.unitSystemSelect=this.getElement('select[name="unitSystem"]'),(a=this.unitSystemSelect)==null||a.addEventListener("change",this.updatePlaceholders.bind(this))}fillForm(e){this.unitSystemSelect&&e.unitSystem&&(this.unitSystemSelect.value=e.unitSystem),this.waistInput&&e.waist&&(this.waistInput.value=e.waist.toString()),this.hipInput&&e.hip&&(this.hipInput.value=e.hip.toString()),this.updatePlaceholders()}updatePlaceholders(){var r,s,n;const a=((r=this.unitSystemSelect)==null?void 0:r.value)===m.IMPERIAL?{waist:"in",hip:"in"}:{waist:"cm",hip:"cm"};(s=this.waistInput)==null||s.setAttribute("placeholder",a.waist),(n=this.hipInput)==null||n.setAttribute("placeholder",a.hip)}bindCalculateEvent(e){var a;(a=this.form)==null||a.addEventListener("submit",r=>{r.preventDefault(),console.log("Form submitted");const s=new FormData(this.form),n={unitSystem:s.get("unitSystem"),waist:parseFloat(s.get("waist")),hip:parseFloat(s.get("hip"))};console.log("Form data:",n),e(n)})}updateResults(e){if(this.resultsTable){const a=this.resultsTable.querySelector("td:nth-child(2)");a&&(a.textContent=e.toFixed(2))}}bindResetEvent(e){var r;const a=(r=this.form)==null?void 0:r.querySelector('button[type="reset"]');a==null||a.addEventListener("click",s=>{s.preventDefault(),e()})}resetForm(){var e;(e=this.form)==null||e.reset(),this.clearResults(),this.updatePlaceholders()}clearResults(){if(this.resultsTable){const e=this.resultsTable.rows;for(let a=0;a<e.length;a++)e[a].cells[1].textContent="-"}}}class gt extends E{constructor(e,a){super(e,a);o(this,"view");o(this,"formValidator");this.view=new ut,this.formValidator=new C}init(e){this.view.render(e),this.fillFormWithUserData(),this.view.bindCalculateEvent(this.handleCalculate.bind(this)),this.view.bindResetEvent(this.handleReset.bind(this))}fillFormWithUserData(){const e=this.user.getData();this.view.fillForm(e)}handleCalculate(e){try{console.log("handleCalculate called with:",e),this.formValidator.validateWaistToHipRatioFormData(e),this.user.setData(e),this.updateView(),this.view.hideError()}catch(a){this.handleErrors(a)}}updateView(){const e=this.calculator.getWaistToHipRatio();console.log("Ratio:",e),this.view.updateResults(e)}handleReset(){this.user.resetData(),this.view.resetForm(),this.view.hideError()}}const mt=`
<section class="container">
...
`;class wt extends T{constructor(){super(...arguments);o(this,"form",null);o(this,"resultsTable",null);o(this,"waistInput",null);o(this,"heightInput",null);o(this,"unitSystemSelect",null)}render(e){var a;e.innerHTML=mt,this.form=this.getElement("#waist-height-ratio-form"),this.resultsTable=this.getElement(".results table"),this.waistInput=this.getElement("#waist"),this.heightInput=this.getElement("#height"),this.unitSystemSelect=this.getElement('select[name="unitSystem"]'),(a=this.unitSystemSelect)==null||a.addEventListener("change",this.updatePlaceholders.bind(this))}fillForm(e){this.unitSystemSelect&&e.unitSystem&&(this.unitSystemSelect.value=e.unitSystem),this.waistInput&&e.waist&&(this.waistInput.value=e.waist.toString()),this.heightInput&&e.height&&(this.heightInput.value=e.height.toString()),this.updatePlaceholders()}updatePlaceholders(){var r,s,n;const a=((r=this.unitSystemSelect)==null?void 0:r.value)===m.IMPERIAL?{waist:"in",height:"in"}:{waist:"cm",height:"cm"};(s=this.waistInput)==null||s.setAttribute("placeholder",a.waist),(n=this.heightInput)==null||n.setAttribute("placeholder",a.height)}bindCalculateEvent(e){var a;(a=this.form)==null||a.addEventListener("submit",r=>{r.preventDefault(),console.log("Form submitted");const s=new FormData(this.form),n={unitSystem:s.get("unitSystem"),waist:parseFloat(s.get("waist")),height:parseFloat(s.get("height"))};console.log("Form data:",n),e(n)})}updateResults(e){if(this.resultsTable){const a=this.resultsTable.querySelector("td:nth-child(2)");a&&(a.textContent=e.toFixed(2))}}bindResetEvent(e){var r;const a=(r=this.form)==null?void 0:r.querySelector('button[type="reset"]');a==null||a.addEventListener("click",s=>{s.preventDefault(),e()})}resetForm(){var e;(e=this.form)==null||e.reset(),this.clearResults(),this.updatePlaceholders()}clearResults(){if(this.resultsTable){const e=this.resultsTable.rows;for(let a=0;a<e.length;a++)e[a].cells[1].textContent="-"}}}class ft extends E{constructor(e,a){super(e,a);o(this,"view");o(this,"formValidator");this.view=new wt,this.formValidator=new C}init(e){this.view.render(e),this.fillFormWithUserData(),this.view.bindCalculateEvent(this.handleCalculate.bind(this)),this.view.bindResetEvent(this.handleReset.bind(this))}fillFormWithUserData(){const e=this.user.getData();this.view.fillForm(e)}handleCalculate(e){try{console.log("handleCalculate called with:",e),this.formValidator.validateWaistHeightRatioFormData(e),this.user.setData(e),this.updateView(),this.view.hideError()}catch(a){this.handleErrors(a)}}updateView(){const e=this.calculator.getWaistToHeightRatio();console.log("Ratio:",e),this.view.updateResults(e)}handleReset(){this.user.resetData(),this.view.resetForm(),this.view.hideError()}}class pt{constructor(t,e){this.user=t,this.calculator=e}createController(t){switch(t){case w.HOME:return new F;case w.BMI:return new ct(this.user,this.calculator);case w.WAIST_TO_HIP:return new gt(this.user,this.calculator);case w.WAIST_TO_HEIGHT:return new ft(this.user,this.calculator);default:throw new Error("404 Not Found")}}}class yt{constructor(t,e){o(this,"currentController",null);o(this,"controllerFactory");this.controllerFactory=new pt(t,e)}listen(){window.addEventListener("hashchange",()=>{const e=window.location.hash.slice(1);this.navigate(e)});const t=window.location.hash.slice(1)||"/";this.navigate(t)}navigate(t){const e=document.getElementById("app");if(!e)return;e.innerHTML="";const a=O(t);if(a!==void 0)try{this.currentController=this.controllerFactory.createController(a),this.currentController.init(e)}catch(r){console.error("Error creating controller:",r),e.innerHTML="<h2>An error occurred</h2>"}else e.innerHTML="<h2>404 Not Found</h2>"}}let y=null;class I{constructor(){o(this,"data");const t=sessionStorage.getItem("userModel");this.data=t?JSON.parse(t):{unitSystem:"metric"}}static getInstance(){return y||(y=new I),y}setData(t){Object.assign(this.data,t),this.saveToSession()}getData(){return{weight:this.data.weight,height:this.data.height,unitSystem:this.data.unitSystem,age:this.data.age,gender:this.data.gender,waist:this.data.waist,hip:this.data.hip,neck:this.data.neck,activityLevel:this.data.activityLevel,dailyCalories:this.data.dailyCalories,weightGoal:this.data.weightGoal,weeksToWeightGoal:this.data.weeksToWeightGoal}}resetData(){this.data={unitSystem:m.METRIC},this.saveToSession()}saveToSession(){sessionStorage.setItem("userModel",JSON.stringify(this.data))}}class vt{constructor(){o(this,"dropdownToggle");o(this,"dropdownMenu");this.dropdownToggle=document.querySelector(".dropdown-toggle"),this.dropdownMenu=document.querySelector(".dropdown-menu"),this.initializeDropdown()}initializeDropdown(){this.dropdownToggle&&this.dropdownMenu&&(this.dropdownToggle.addEventListener("click",this.toggleDropdown.bind(this)),document.addEventListener("click",this.handleOutsideClick.bind(this)))}toggleDropdown(t){var e;t.preventDefault(),(e=this.dropdownMenu)==null||e.classList.toggle("show")}handleOutsideClick(t){var e;this.dropdownToggle&&!this.dropdownToggle.contains(t.target)&&((e=this.dropdownMenu)==null||e.classList.remove("show"))}}class Tt{constructor(){o(this,"router");o(this,"user");o(this,"calculator");this.user=I.getInstance(),this.calculator=new ht(this.user),this.router=new yt(this.user,this.calculator),new vt}start(){this.router.listen();const t=window.location.hash.slice(1)||"/";this.router.navigate(t)}}const Et=new Tt;Et.start();

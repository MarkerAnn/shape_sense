...
`;class ve extends f{constructor(e){super(e)}render(e){e.innerHTML=ye,this.initializeCommonElements(),this.initializeInputs(["hip","waist"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.waistToHipRatio}}class fe extends w{constructor(t,i,r){super(t,i,r);n(this,"view");this.view=new ve(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateWaistToHipRatioFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),waist:parseFloat(t.get("waist")),hip:parseFloat(t.get("hip"))}}updateView(){const t=this.calculator.getWaistToHipRatio(),i={waistToHipRatio:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return t.toFixed(2)}}const we=`
<section class="container">
...
`;class Be extends f{constructor(e){super(e)}render(e){e.innerHTML=Ae,this.initializeCommonElements(),this.initializeInputs(["weight","height","age","weightGoal","dailyCalories"]),this.initializeSelectField("unitSystem")}updateResults(e){if(!this.resultsTable)return;const t=this.resultsTable.rows;t[0].cells[1].textContent=e.weeksToWeightGoal}}class Ge extends w{constructor(t,i,r){super(t,i,r);n(this,"view");this.view=new Be(this.getUnitSystemValue.bind(this))}init(t){this.view.render(t),this.fillFormData(this.user.getData()),this.bindFormEvents(this.handleCalculate.bind(this))}getUnitSystemValue(){return this.user.getData().unitSystem??c.METRIC}handleCalculate(t){try{const i=this.parseFormData(t);this.formValidator.validateTotalDailyEnergyExpenditureFormData(i),this.user.setData(i),this.updateView(),this.view.hideError()}catch(i){this.handleErrors(i)}}parseFormData(t){return{unitSystem:t.get("unitSystem"),gender:t.get("gender"),weight:parseFloat(t.get("weight")),height:parseFloat(t.get("height")),age:parseFloat(t.get("age")),activityLevel:t.get("activityLevel"),weightGoal:parseFloat(t.get("weightGoal")),dailyCalories:parseFloat(t.get("dailyCalories"))}}updateView(){const t=this.calculator.getEstimateTimeToWeightGoal(),i={weeksToWeightGoal:this.formatValue(t)};this.view.updateResults(i)}formatValue(t){return`${t.toFixed(1)} weeks`}}const $e=`
  <section class="container">
